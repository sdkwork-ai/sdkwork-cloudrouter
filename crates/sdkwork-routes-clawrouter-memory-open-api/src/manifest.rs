...
pub const PACKAGE_NAME: &str = "sdkwork-routes-clawrouter-memory-open-api";
pub const CAPABILITY: &str = "clawrouter-memory";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-clawrouter.memory-open-api";
