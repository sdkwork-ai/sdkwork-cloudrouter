...
pub const PACKAGE_NAME: &str = "sdkwork-routes-cloudrouter-backend-api";
pub const CAPABILITY: &str = "router";
pub const SURFACE: &str = "backend-api";
pub const API_AUTHORITY: &str = "sdkwork-cloudrouter.backend-api";
pub const SDK_FAMILY: &str = "cloudrouter-backend-sdk";
