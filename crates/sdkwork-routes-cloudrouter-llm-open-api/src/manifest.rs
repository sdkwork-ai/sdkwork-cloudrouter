...
pub const PACKAGE_NAME: &str = "sdkwork-routes-cloudrouter-llm-open-api";
pub const CAPABILITY: &str = "cloudrouter-llm";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-cloudrouter.llm-open-api";
