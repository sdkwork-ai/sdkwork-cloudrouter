# SDKWork Cloud Config Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-config`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-config` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-config` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-config/Cargo.toml`
