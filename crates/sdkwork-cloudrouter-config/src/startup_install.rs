...
impl StartupInstallMode {
    pub const ENV_STARTUP_INSTALL_MODE: &'static str = "SDKWORK_CLOUDROUTER_STARTUP_INSTALL_MODE";
    pub const ENV_ROUTER_ENVIRONMENT: &'static str = "SDKWORK_CLOUDROUTER_ROUTER_ENVIRONMENT";
