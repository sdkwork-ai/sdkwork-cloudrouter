...
impl DeploymentMode {
    pub const ENV_DEPLOYMENT_MODE: &'static str = "SDKWORK_CLOUDROUTER_DEPLOYMENT_MODE";
...
impl RuntimeTarget {
    pub const ENV_RUNTIME_TARGET: &'static str = "SDKWORK_CLOUDROUTER_ROUTER_RUNTIME_TARGET";
