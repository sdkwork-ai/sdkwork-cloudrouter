...
impl RedisConfig {
    pub const ENV_REDIS_ENABLED: &'static str = "SDKWORK_CLOUDROUTER_REDIS_ENABLED";
    pub const ENV_REDIS_HOST: &'static str = "SDKWORK_CLOUDROUTER_REDIS_HOST";
    pub const ENV_REDIS_PORT: &'static str = "SDKWORK_CLOUDROUTER_REDIS_PORT";
    pub const ENV_REDIS_DATABASE: &'static str = "SDKWORK_CLOUDROUTER_REDIS_DATABASE";
    pub const ENV_REDIS_USERNAME: &'static str = "SDKWORK_CLOUDROUTER_REDIS_USERNAME";
    pub const ENV_REDIS_URL: &'static str = "SDKWORK_CLOUDROUTER_REDIS_URL";
    pub const ENV_REDIS_PASSWORD: &'static str = "SDKWORK_CLOUDROUTER_REDIS_PASSWORD";
    pub const ENV_REDIS_PASSWORD_FILE: &'static str = "SDKWORK_CLOUDROUTER_REDIS_PASSWORD_FILE";
    pub const ENV_REDIS_KEY_PREFIX: &'static str = "SDKWORK_CLOUDROUTER_REDIS_KEY_PREFIX";
    pub const ENV_REDIS_TLS: &'static str = "SDKWORK_CLOUDROUTER_REDIS_TLS";
    pub const ENV_REDIS_MAX_CONNECTIONS: &'static str = "SDKWORK_CLOUDROUTER_REDIS_MAX_CONNECTIONS";
    pub const ENV_REDIS_CONNECT_TIMEOUT_MILLIS: &'static str =
        "SDKWORK_CLOUDROUTER_REDIS_CONNECT_TIMEOUT_MILLIS";
    pub const ENV_REDIS_COMMAND_TIMEOUT_MILLIS: &'static str =
        "SDKWORK_CLOUDROUTER_REDIS_COMMAND_TIMEOUT_MILLIS";
    pub const ENV_REDIS_POOL_IDLE_TIMEOUT_SECONDS: &'static str =
        "SDKWORK_CLOUDROUTER_REDIS_POOL_IDLE_TIMEOUT_SECONDS";
