...
impl ProviderAdapterConfig {
    pub const ENV_PROVIDER_ADAPTER_JSON: &'static str = "SDKWORK_CLOUDROUTER_PROVIDER_ADAPTER_JSON";
    pub const ENV_PROVIDER_ADAPTER_JSON_FILE: &'static str =
        "SDKWORK_CLOUDROUTER_PROVIDER_ADAPTER_JSON_FILE";
    ...
    pub const ENV_PROVIDER_ADAPTER_MANIFEST: &'static str =
        "SDKWORK_CLOUDROUTER_PROVIDER_ADAPTER_MANIFEST";
