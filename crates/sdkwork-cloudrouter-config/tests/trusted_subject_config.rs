use sdkwork_cloudrouter_config::{RuntimeTomlConfig, TrustedSubjectConfig};
...
fn rejects_blank_short_or_invalid_trusted_subject_config() {
    ...
    assert!(blank.contains("SDKWORK_CLOUDROUTER_TRUSTED_SUBJECT_SECRET"));
    ...
    .unwrap_err();
    assert!(invalid_skew.contains("SDKWORK_CLOUDROUTER_TRUSTED_SUBJECT_MAX_CLOCK_SKEW_SECONDS"));
