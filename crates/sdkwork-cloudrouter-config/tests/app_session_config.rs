use sdkwork_cloudrouter_config::{AppSessionConfig, RuntimeTomlConfig};
...
fn rejects_blank_short_or_invalid_app_session_config() {
    ...
    assert!(blank.contains("SDKWORK_CLOUDROUTER_APP_SESSION_SECRET"));
    ...
    .unwrap_err();
    assert!(invalid_ttl.contains("SDKWORK_CLOUDROUTER_APP_SESSION_TTL_SECONDS"));
