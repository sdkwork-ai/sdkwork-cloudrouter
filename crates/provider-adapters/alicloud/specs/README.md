...
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/provider-adapters/alicloud` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/provider-adapters/alicloud/Cargo.toml`
