...
pub const PACKAGE_NAME: &str = "sdkwork-routes-clawrouter-drive-open-api";
pub const CAPABILITY: &str = "clawrouter-drive";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-clawrouter.drive-open-api";
