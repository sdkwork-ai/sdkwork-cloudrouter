...
pub const PACKAGE_NAME: &str = "sdkwork-routes-clawrouter-knowledgebase-open-api";
pub const CAPABILITY: &str = "clawrouter-knowledgebase";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-clawrouter.knowledgebase-open-api";
