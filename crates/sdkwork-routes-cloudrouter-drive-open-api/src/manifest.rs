...
pub const PACKAGE_NAME: &str = "sdkwork-routes-cloudrouter-drive-open-api";
pub const CAPABILITY: &str = "cloudrouter-drive";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-cloudrouter.drive-open-api";
