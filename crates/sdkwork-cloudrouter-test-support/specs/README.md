# SDKWork Cloud Test Support Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-test-support`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-test-support` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-test-support` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
