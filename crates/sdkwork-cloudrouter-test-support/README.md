...
This README is the SDKWork module entrypoint for `sdkwork-cloudrouter-test-support`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-test-support/Cargo.toml`
