//! OpenTelemetry trace-export configuration for Cloud Router.
//!
//! Prometheus metrics are recorded by `sdkwork-web-framework` and
//! `sdkwork-cloudrouter-http`, then exposed on the serving process' existing
...
impl Default for OtlpConfig {
    fn default() -> Self {
        Self {
            ...
            service_name: "sdkwork-cloudrouter".to_owned(),
            sampling_rate: 1.0,
