# SDKWork Cloud Observability Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-observability`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-observability` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-observability` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-observability/Cargo.toml`
