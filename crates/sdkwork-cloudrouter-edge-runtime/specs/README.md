# SDKWork Cloud Gateway Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-edge-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-edge-runtime` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-edge-runtime` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-edge-runtime/Cargo.toml`
