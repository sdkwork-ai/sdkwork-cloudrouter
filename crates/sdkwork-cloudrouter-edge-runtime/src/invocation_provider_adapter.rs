...
use sdkwork_cloudrouter_router_service::ports::ProviderAdapterRouteResolver;
...
fn provider_native_capability_code(
    capability: sdkwork_cloudrouter_router_service::domain::RoutingCapability,
) -> &'static str {
    match capability {
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Chat => "chat",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Embedding => "embedding",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Image => "image_generation",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Audio => "audio",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Music => "music_generation",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Video => "video_generation",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Rerank => "rerank",
        sdkwork_cloudrouter_router_service::domain::RoutingCapability::Network => "network",
    }
}
