...
pub const ENV_EDGE_SERVER_ENABLED: &str = "SDKWORK_CLOUDROUTER_EDGE_SERVER";
const ENV_EDGE_GATEWAY_BASE_URL: &str = "SDKWORK_CLOUDROUTER_EDGE_GATEWAY_BASE_URL";
const ENV_EDGE_BACKEND_API_BASE_URL: &str = "SDKWORK_CLOUDROUTER_EDGE_BACKEND_API_BASE_URL";
const ENV_EDGE_APP_API_BASE_URL: &str = "SDKWORK_CLOUDROUTER_EDGE_APP_API_BASE_URL";
const ENV_EDGE_PORTAL_BASE_URL: &str = "SDKWORK_CLOUDROUTER_EDGE_PORTAL_BASE_URL";
const ENV_EDGE_PORTAL_STATIC_DIST: &str = "SDKWORK_CLOUDROUTER_EDGE_PORTAL_STATIC_DIST";
const ENV_EDGE_EXTERNAL_SCHEME: &str = "SDKWORK_CLOUDROUTER_EDGE_EXTERNAL_SCHEME";
pub const ENV_EDGE_TRUST_FORWARDED_HEADERS: &str =
    "SDKWORK_CLOUDROUTER_EDGE_TRUST_FORWARDED_HEADERS";
const ENV_EDGE_UPSTREAM_REQUEST_TIMEOUT_MILLIS: &str =
    "SDKWORK_CLOUDROUTER_EDGE_UPSTREAM_REQUEST_TIMEOUT_MILLIS";
...
pub fn edge_server_config_from_env_or_runtime_toml(
    ...
    let portal_static_dist = sdkwork_cloudrouter_config::runtime::config_value(
        ENV_EDGE_PORTAL_STATIC_DIST,
        edge.and_then(|config| config.portal_static_dist.as_deref()),
    );
    let portal_base_url = sdkwork_cloudrouter_config::runtime::config_value(
    ...
    if let Some(value) = sdkwork_cloudrouter_config::runtime::config_value(
    ...
    if let Some(value) = sdkwork_cloudrouter_config::runtime::config_bool(
    ...
    if let Some(value) = sdkwork_cloudrouter_config::runtime::config_u64(
...
fn required_config_value(name: &str, configured: Option<&str>) -> Result<String, String> {
    sdkwork_cloudrouter_config::runtime::config_value(name, configured)
...
mod tests {
    ...
    fn enabled_edge_server_requires_every_upstream() {
        ...
        assert!(error.contains("SDKWORK_CLOUDROUTER_EDGE_APP_API_BASE_URL"));
    }
