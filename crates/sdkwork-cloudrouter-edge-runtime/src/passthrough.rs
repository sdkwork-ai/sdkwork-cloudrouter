...
use sdkwork_cloudrouter_provider_adapter_http::{
...
mod tests {
    ...
    fn provider_adapter_standard_api_code_never_falls_back_to_private_endpoint_key() {
        let mut route = ProviderAdapterRouteConfig {
            ...
            adapter_kind: sdkwork_cloudrouter_provider_adapter_contract::AdapterKind::InternalHttp,
            ...
            runtime_state: sdkwork_cloudrouter_provider_adapter_contract::AdapterEndpointRuntimeState::RuntimeAvailable,
            ...
            status: sdkwork_cloudrouter_provider_adapter_contract::AdapterRouteStatus::Enabled,
            priority: 10,
        };
        assert_eq!(
