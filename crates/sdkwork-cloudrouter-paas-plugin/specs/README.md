...
This directory is the local SDKWork component contract for `sdkwork-cloudrouter-paas-plugin`.

- Component root: `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-paas-plugin`
