...
pub const PACKAGE_NAME: &str = "sdkwork-routes-cloudrouter-knowledgebase-open-api";
pub const CAPABILITY: &str = "cloudrouter-knowledgebase";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-cloudrouter.knowledgebase-open-api";
