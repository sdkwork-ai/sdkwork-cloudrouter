# SDKWork Cloud Contract Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-contract`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-contract` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-contract` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-contract/Cargo.toml`
