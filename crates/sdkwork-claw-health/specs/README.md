# SDKWork Claw Health Component Specs

This directory is the local standards index for `sdkwork-claw-health`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-claw-health` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/sdkwork-claw-health` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
