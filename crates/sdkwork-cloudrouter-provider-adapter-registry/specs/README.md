# SDKWork Cloud Provider Adapter Registry Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-provider-adapter-registry`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-provider-adapter-registry` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter-registry` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter-registry/Cargo.toml`
