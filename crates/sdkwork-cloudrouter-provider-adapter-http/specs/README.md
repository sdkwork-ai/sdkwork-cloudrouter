# SDKWork Cloud Provider Adapter Http Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-provider-adapter-http`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-provider-adapter-http` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter-http` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter-http/Cargo.toml`
