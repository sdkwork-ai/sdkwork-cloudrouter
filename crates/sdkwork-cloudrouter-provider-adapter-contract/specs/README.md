# SDKWork Cloud Provider Adapter Contract Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-provider-adapter-contract`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-provider-adapter-contract` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter-contract` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter-contract/Cargo.toml`
