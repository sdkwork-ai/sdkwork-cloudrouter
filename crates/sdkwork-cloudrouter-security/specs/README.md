# SDKWork Cloud Security Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-security`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-security` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-security` |
| Domain | `iam` |
| Capability | `security` |
| Languages | `rust` |
