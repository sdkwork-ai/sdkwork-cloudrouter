...
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/crates/sdkwork-cloudrouter-provider-adapter/Cargo.toml`
