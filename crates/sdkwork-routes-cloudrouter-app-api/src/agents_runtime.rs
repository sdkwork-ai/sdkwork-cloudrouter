//! Federated Agents app-api route wiring for Cloud Router database-backed runtime.
//!
...
//! directly by the Cloud Router gateway. Dependency assembly composition keeps
...
pub async fn merge_federated_agents_app_router(
    ...
    if database_config.engine != DatabaseEngine::Postgres {
        tracing::info!(
            target: "sdkwork.cloudrouter.agents",
