...
pub const PACKAGE_NAME: &str = "sdkwork-routes-cloudrouter-app-api";
pub const CAPABILITY: &str = "router";
pub const SURFACE: &str = "app-api";
pub const API_AUTHORITY: &str = "sdkwork-cloudrouter.app-api";
pub const SDK_FAMILY: &str = "cloudrouter-app-sdk";
