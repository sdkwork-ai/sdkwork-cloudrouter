...
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/sdkwork-claw-provider-adapter-core` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/crates/sdkwork-claw-provider-adapter-core/Cargo.toml`
