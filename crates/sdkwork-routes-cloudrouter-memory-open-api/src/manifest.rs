...
pub const PACKAGE_NAME: &str = "sdkwork-routes-cloudrouter-memory-open-api";
pub const CAPABILITY: &str = "cloudrouter-memory";
pub const SURFACE: &str = "open-api";
pub const API_AUTHORITY: &str = "sdkwork-cloudrouter.memory-open-api";
