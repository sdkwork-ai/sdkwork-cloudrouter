...
This directory is the local standards index for `sdkwork-clawrouter-edge-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-edge-runtime` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/sdkwork-clawrouter-edge-runtime` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
