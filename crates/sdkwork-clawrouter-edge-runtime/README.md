...
This README is the SDKWork module entrypoint for `sdkwork-clawrouter-edge-runtime`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/crates/sdkwork-clawrouter-edge-runtime/Cargo.toml`
