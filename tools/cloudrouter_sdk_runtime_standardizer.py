...
SDK_DIRECTORIES = ("cloudrouter-app-sdk", "cloudrouter-backend-sdk", "cloudrouter-open-sdk")
...
SDK_COMMON_VERSION = "workspace:*"
SDK_TYPES_NODE_VERSION = "20.19.39"
SDK_TYPESCRIPT_VERSION = "5.8.3"
SDK_ROLLUP_VERSION = "4.60.1"
SDK_TYPES = {
    "cloudrouter-app-sdk": "app",
    "cloudrouter-backend-sdk": "backend",
    "cloudrouter-open-sdk": "ai",
}
SDK_OWNER = "sdkwork-cloudrouter"
SDK_API_AUTHORITIES = {
    "cloudrouter-app-sdk": "sdkwork-cloudrouter.app",
    "cloudrouter-backend-sdk": "sdkwork-cloudrouter.backend",
    "cloudrouter-open-sdk": "sdkwork-cloudrouter.ai",
}
SDK_TYPESCRIPT_DIRECTORIES = {
    "cloudrouter-app-sdk": "cloudrouter-app-sdk-typescript",
    "cloudrouter-backend-sdk": "cloudrouter-backend-sdk-typescript",
    "cloudrouter-open-sdk": "cloudrouter-open-sdk-typescript",
}
SDK_PACKAGE_NAMES = {
    "cloudrouter-app-sdk": "@sdkwork/cloudrouter-app-sdk",
    "cloudrouter-backend-sdk": "@sdkwork/cloudrouter-backend-sdk",
    "cloudrouter-open-sdk": "@sdkwork/cloudrouter-open-sdk",
}
SDK_LANGUAGE_PACKAGE_NAMES = {
    "cloudrouter-app-sdk": {
        "typescript": "@sdkwork/cloudrouter-app-sdk",
        "flutter": "cloudrouter_app_sdk",
        "rust": "cloudrouter-app-sdk",
        "java": "com.sdkwork.cloudrouter:cloudrouter-app-sdk",
        "csharp": "Sdkwork.CloudRouter.App.Sdk",
        "swift": "CloudRouterAppSdk",
        "kotlin": "com.sdkwork.cloudrouter:cloudrouter-app-sdk",
        "go": "github.com/sdkwork/cloudrouter-app-sdk",
        "python": "sdkwork-cloudrouter-app-sdk",
    },
    "cloudrouter-backend-sdk": {
        "typescript": "@sdkwork/cloudrouter-backend-sdk",
        "flutter": "cloudrouter_backend_sdk",
        "rust": "cloudrouter-backend-sdk",
        "java": "com.sdkwork.cloudrouter:cloudrouter-backend-sdk",
        "csharp": "Sdkwork.CloudRouter.Backend.Sdk",
        "swift": "CloudRouterBackendSdk",
        "kotlin": "com.sdkwork.cloudrouter:cloudrouter-backend-sdk",
        "go": "github.com/sdkwork/cloudrouter-backend-sdk",
        "python": "sdkwork-cloudrouter-backend-sdk",
    },
...
SDK_LANGUAGE_NAMESPACES = {
    "cloudrouter-app-sdk": {
        "java": "com.sdkwork.cloudrouter.app",
        "kotlin": "com.sdkwork.cloudrouter.app",
        "csharp": "Sdkwork.CloudRouter.App",
    },
    "cloudrouter-backend-sdk": {
        "java": "com.sdkwork.cloudrouter.backend",
        "kotlin": "com.sdkwork.cloudrouter.backend",
        "csharp": "Sdkwork.CloudRouter.Backend",
    },
    "cloudrouter-open-sdk": {
        "java": "com.sdkwork.cloudrouter.open",
        "kotlin": "com.sdkwork.cloudrouter.open",
        "csharp": "Sdkwork.CloudRouter.Open",
    },
}
SDK_LANGUAGE_MANIFESTS = {
    ...
    "rust": "Cargo.toml",
    "java": "pom.xml",
    "csharp": "Sdkwork.CloudRouter.Sdk.Generated.csproj",
    "swift": "Package.swift",
...
SDK_CLIENTS = {
    "cloudrouter-app-sdk": "SdkworkAppClient",
    "cloudrouter-backend-sdk": "SdkworkBackendClient",
    "cloudrouter-open-sdk": "SdkworkAiClient",
}
SDK_API_PREFIXES = {
    "cloudrouter-app-sdk": "/app/v3/api",
    "cloudrouter-backend-sdk": "/backend/v3/api",
    "cloudrouter-open-sdk": "/v1",
}
SDK_DESCRIPTIONS = {
    "cloudrouter-app-sdk": "SDKWork Cloud Router app API SDK",
    "cloudrouter-backend-sdk": "SDKWork Cloud Router backend API SDK",
    "cloudrouter-open-sdk": "SDKWork Cloud Router OpenAI-compatible gateway SDK",
}
SDK_GENERATED_OPENAPI_PATHS = {
    "cloudrouter-app-sdk": Path("generated/openapi/cloudrouter-app-openapi.json"),
    "cloudrouter-backend-sdk": Path("generated/openapi/cloudrouter-backend-openapi.json"),
    "cloudrouter-open-sdk": Path("apps/sdkwork-cloudrouter-pc/public/openapi.json"),
}
...
SDK_DEPENDENCIES = {
    ...
    "cloudrouter-backend-sdk": [
        ...
        {
            "workspace": "sdkwork-partner-backend-sdk",
            "role": "partner-backend-management-capability",
            "required": True,
            "dependencyMode": "consumer-sdk",
            "apiPrefix": "/backend/v3/api",
            "generatedTransportImportPolicy": "forbidden",
...
def sdk_generation_input_spec(sdk_family: str) -> str:
    if sdk_family == "cloudrouter-open-sdk":
...
class SdkRuntimeStandardizer:
    ...
    def _standardize_generated_http_clients(self, sdk_family: str, base: Path) -> list[Path]:
        if sdk_family not in {"cloudrouter-app-sdk", "cloudrouter-backend-sdk"}:
            return []
    ...
    def _annotate_owner_metadata(self, payload: dict[str, Any], sdk_family: str) -> None:
        ...
        if sdk_family == "cloudrouter-open-sdk":
            ...
            if isinstance(info, dict):
                ...
                info["x-sdkwork-external-protocol-id"] = "cloudrouter-vendor-gateway"
    ...
    def _write_sdkgen_payload_if_changed(self, sdk_family: str, payload: dict[str, Any], target: Path) -> list[Path]:
        derived = self._derive_sdkgen_openapi(payload) if sdk_family == "cloudrouter-open-sdk" else payload
    ...
    def _standardize_component_spec(self, sdk_family: str, family: Path) -> list[Path]:
        ...
        if isinstance(sdk_clients, list):
            contracts["sdkClients"] = [
                item for item in sdk_clients if item != "SdkworkCloudrouterAppDomainsClient"
            ]
        ...
        if isinstance(verification, dict):
            ...
            if isinstance(commands, list):
                verification["commands"] = [
                    ...
                    if item != "node --test sdks/test/verify-cloudrouter-domains-facade.test.mjs"
                ]
    ...
    def _render_generate_script(self, sdk_family: str) -> str:
        ...
        base_url = {
            "cloudrouter-app-sdk": "http://localhost:18082",
            "cloudrouter-backend-sdk": "http://localhost:18081",
            "cloudrouter-open-sdk": "https://api.sdkwork.com",
        }[sdk_family]
        ...
        standard_profile_line = (
            ...
            if sdk_family in {"cloudrouter-app-sdk", "cloudrouter-backend-sdk"}
            else ""
        )
        return (
            "#!/usr/bin/env node\n"
            ...
            "    '-B',\n"
            "    '-m',\n"
            "    'tools.cloudrouter_sdk_runtime_standardizer',\n"
            "    '--root',\n"
            "    workspaceRoot,\n"
            "    '--sdk-dir',\n"
            "    sdkFamily,\n"
            ...
            "  return [\n"
            "    'tools/cloudrouter_strict_sdk_generate.mjs',\n"
            "    'generate',\n"
    ...
    def _standardize_sdk(self, sdk_family: str, base: Path) -> list[Path]:
        ...
        if isinstance(imports, dict):
            imports.pop("#cloudrouter-backend-domains-generated", None)
            if not imports:
        ...
        if types_dir.is_dir():
            ...
            for type_path in sorted(types_dir.glob("*.ts")):
                ...
                elif sdk_family in {"cloudrouter-app-sdk", "cloudrouter-backend-sdk"} and self._is_request_input_type_file(type_path):
        ...
        if sdk_family == "cloudrouter-backend-sdk":
        ...
        if sdk_family == "cloudrouter-app-sdk":
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Apply sdkwork-cloudrouter generated SDK runtime build standard.")
