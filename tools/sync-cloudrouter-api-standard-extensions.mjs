...
const TARGETS = [
  {
    ...
    prefix: "/app/v3/api",
    crateRoot: "crates/sdkwork-routes-cloudrouter-app-api",
    openApiPaths: [
  ...
  },
  {
    ...
    packageName: "sdkwork-routes-cloudrouter-backend-api",
    capability: "router",
    apiAuthority: "sdkwork-cloudrouter-backend-api",
    sdkFamily: "cloudrouter-backend-sdk",
    prefix: "/backend/v3/api",
    crateRoot: "crates/sdkwork-routes-cloudrouter-backend-api",
    openApiPaths: [
  ...
  },
  {
    surface: "open-api",
    apiSurface: "open-api",
    packageName: "sdkwork-routes-cloudrouter-open-api",
    capability: "router",
    apiAuthority: "sdkwork-cloudrouter-open-api",
    sdkFamily: "cloudrouter-open-sdk",
    prefix: "/v1",
    crateRoot: "crates/sdkwork-routes-cloudrouter-llm-open-api",
    openApiPaths: [
...
function inferSdkworkPermission(operation, routePath) {
  ...
  const explicitPermissions = {
    'installation.status.retrieve': 'cloudrouter.system.read',
    'monitor.alerts.list': 'cloudrouter.system.read',
    'monitor.nodes.list': 'cloudrouter.system.read',
    'monitor.performance.list': 'cloudrouter.system.read',
    'rateLimits.apiKeys.list': 'cloudrouter.gateway.read',
    'rateLimits.apiKeys.create': 'cloudrouter.gateway.manage',
    'rateLimits.apiKeys.delete': 'cloudrouter.gateway.manage',
    'firewalls.rules.list': 'cloudrouter.gateway.read',
    'firewalls.rules.create': 'cloudrouter.gateway.manage',
    'firewalls.rules.delete': 'cloudrouter.gateway.manage',
  };
...
function buildRouteEntries(document, target) {
  const routes = [];
  const paths = document.paths ?? {};
  for (const [routePath, pathItem] of Object.entries(paths)) {
    if (!pathItem || typeof pathItem !== "object") {
...
function buildRouteManifest(document, target) {
  return {
    ...
    routes: buildRouteEntries(document, target),
  };
}
