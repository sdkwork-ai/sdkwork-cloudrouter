...
BASELINE_PATH = ROOT / "database/ddl/baseline/postgres/0001_cloudrouter_baseline.sql"
...
def update_assembly_guardrails(assembly: dict) -> None:
    ...
    guard["rule"] = (
        "Cloud-router generated ownership is limited to gateway routing, metering, pricing, "
        ...
        "external sibling modules and must not be generated in cloud-router schema.sql."
    )
        ...
        yaml.safe_dump(
            {
                ...
                "owner_team": "cloud-router-platform",
                "compliance_level": "L2",
                "engines": ["postgres"],
                "table_prefix": "ai_",
                "tables": [
...
def main() -> None:
    ...
    print(f"generated cloud-router tables: {len(generated_tables)}")
