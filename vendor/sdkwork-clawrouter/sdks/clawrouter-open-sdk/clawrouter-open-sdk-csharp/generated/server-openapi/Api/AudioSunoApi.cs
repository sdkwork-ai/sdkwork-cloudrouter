...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class AudioSunoApi
    {
        ...
        public AudioSunoApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.SunoMusicGenerationResponse?> CreateV1MusicGenerationAsync(Sdkwork.ClawRouter.Open.Models.SunoMusicGenerationRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.SunoMusicGenerationResponse>(ApiPaths.AiPath("/suno/v1/music/generations"), body, null, null, "application/json");
        }

        /// <summary>
        /// Suno retrieve music generation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.SunoMusicGenerationTaskResponse?> ListV1MusicGenerationsAsync(string taskId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.SunoMusicGenerationTaskResponse>(ApiPaths.AiPath($"/suno/v1/music/generations/{SerializePathParameter(taskId, new PathParameterSpec("task_id", "simple", false))}"));
        }
