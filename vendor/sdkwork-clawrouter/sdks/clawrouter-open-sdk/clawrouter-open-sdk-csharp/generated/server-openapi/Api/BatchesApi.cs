...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class BatchesApi
    {
        ...
        /// List batches
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiBatchList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiBatchList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/batches"), queryString));
        }

        /// <summary>
        /// Create batch
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiBatch?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiBatchCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiBatch>(ApiPaths.AiPath("/batches"), body, null, null, "application/json");
        }

        /// <summary>
        /// Retrieve batch
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiBatch?> RetrieveAsync(string batchId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiBatch>(ApiPaths.AiPath($"/batches/{SerializePathParameter(batchId, new PathParameterSpec("batch_id", "simple", false))}"));
        }

        /// <summary>
        /// Cancel batch
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiBatch?> CancelAsync(string batchId)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiBatch>(ApiPaths.AiPath($"/batches/{SerializePathParameter(batchId, new PathParameterSpec("batch_id", "simple", false))}/cancel"), null);
        }
