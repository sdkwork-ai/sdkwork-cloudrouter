...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ResponsesGoogleApi
    {
        ...
        public ResponsesGoogleApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleCachedContentListResponse?> ListV1betaCachedContentsAsync(int? pageSize = null, string? pageToken = null)
        {
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleCachedContent?> CreateV1betaCachedContentAsync(Sdkwork.ClawRouter.Open.Models.GoogleCachedContentCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.GoogleCachedContent>(ApiPaths.AiPath("/google/v1beta/cachedContents"), body, null, null, "application/json");
        }

        /// <summary>
        /// Google Gemini cached content
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleEmptyResponse?> DeleteV1betaCachedContentsAsync(string cachedContentId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.GoogleEmptyResponse>(ApiPaths.AiPath($"/google/v1beta/cachedContents/{SerializePathParameter(cachedContentId, new PathParameterSpec("cached_content_id", "simple", false))}"));
        }
