...
type ImagesMidjourneyApi struct {
    client *sdkhttp.Client
}

func NewImagesMidjourneyApi(client *sdkhttp.Client) *ImagesMidjourneyApi {
    return &ImagesMidjourneyApi{client: client}
}
...
func (a *ImagesMidjourneyApi) CreateV1ImagesGeneration(body sdktypes.MidjourneyImageGenerationRequest) (sdktypes.MidjourneyImageGenerationTask, error) {
    ...
    return decodeResult[sdktypes.MidjourneyImageGenerationTask](raw)
}
