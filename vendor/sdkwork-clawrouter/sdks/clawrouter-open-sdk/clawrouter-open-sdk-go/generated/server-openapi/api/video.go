...
// List videos
func (a *VideoApi) List(limit *int, order *string, after *string, before *string) (sdktypes.OpenAiVideoList, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(AiApiPath("/videos"), query), nil, nil)
    if err != nil {
...
// Create video
func (a *VideoApi) Create(body sdktypes.OpenAiVideoCreateRequest) (sdktypes.OpenAiVideo, error) {
    raw, err := a.client.Post(AiApiPath("/videos"), body, nil, nil, "application/json")
    if err != nil {
...
func (a *VideoApi) CreateCharacter(body sdktypes.OpenAiVideoCharacterCreateRequest) (sdktypes.OpenAiVideoCharacter, error) {
    raw, err := a.client.Post(AiApiPath("/videos/characters"), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.OpenAiVideoCharacter
        return zero, err
    }
    return decodeResult[sdktypes.OpenAiVideoCharacter](raw)
}

// Retrieve video character
func (a *VideoApi) ListCharacters(characterId string) (sdktypes.OpenAiVideoCharacter, error) {
    raw, err := a.client.Get(AiApiPath(fmt.Sprintf("/videos/characters/%s", SerializePathParameter(characterId, PathParameterSpec{Name: "character_id", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero sdktypes.OpenAiVideoCharacter
        return zero, err
    }
...
// Edit video
func (a *VideoApi) CreateEdit(body sdktypes.OpenAiVideoEditRequest) (sdktypes.OpenAiVideo, error) {
    raw, err := a.client.Post(AiApiPath("/videos/edits"), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.OpenAiVideo
        return zero, err
    }
...
// Extend video
func (a *VideoApi) CreateExtension(body sdktypes.OpenAiVideoExtendRequest) (sdktypes.OpenAiVideo, error) {
    raw, err := a.client.Post(AiApiPath("/videos/extensions"), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.OpenAiVideo
        return zero, err
    }
...
// Delete video
func (a *VideoApi) Delete(videoId string) (sdktypes.DeleteResult, error) {
    raw, err := a.client.Delete(AiApiPath(fmt.Sprintf("/videos/%s", SerializePathParameter(videoId, PathParameterSpec{Name: "video_id", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
...
// Retrieve video
func (a *VideoApi) Retrieve(videoId string) (sdktypes.OpenAiVideo, error) {
    raw, err := a.client.Get(AiApiPath(fmt.Sprintf("/videos/%s", SerializePathParameter(videoId, PathParameterSpec{Name: "video_id", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero sdktypes.OpenAiVideo
        return zero, err
    }
...
// Remix video
func (a *VideoApi) CreateRemix(videoId string, body sdktypes.OpenAiVideoRemixRequest) (sdktypes.OpenAiVideo, error) {
    raw, err := a.client.Post(AiApiPath(fmt.Sprintf("/videos/%s/remix", SerializePathParameter(videoId, PathParameterSpec{Name: "video_id", Style: "simple", Explode: false}))), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.OpenAiVideo
        return zero, err
    }
