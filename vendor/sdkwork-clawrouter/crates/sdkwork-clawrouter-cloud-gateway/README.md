...
This README is the SDKWork module entrypoint for `sdkwork-clawrouter-cloud-gateway`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/crates/sdkwork-clawrouter-cloud-gateway/Cargo.toml`
