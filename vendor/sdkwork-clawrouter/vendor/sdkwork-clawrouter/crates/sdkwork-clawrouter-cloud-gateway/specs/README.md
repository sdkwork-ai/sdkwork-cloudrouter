...
This directory is the local standards index for `sdkwork-clawrouter-cloud-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-cloud-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/sdkwork-clawrouter-cloud-gateway` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
