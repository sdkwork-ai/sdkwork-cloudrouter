...
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/services/sdkwork-claw-provider-adapter` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/services/sdkwork-claw-provider-adapter/Cargo.toml`
