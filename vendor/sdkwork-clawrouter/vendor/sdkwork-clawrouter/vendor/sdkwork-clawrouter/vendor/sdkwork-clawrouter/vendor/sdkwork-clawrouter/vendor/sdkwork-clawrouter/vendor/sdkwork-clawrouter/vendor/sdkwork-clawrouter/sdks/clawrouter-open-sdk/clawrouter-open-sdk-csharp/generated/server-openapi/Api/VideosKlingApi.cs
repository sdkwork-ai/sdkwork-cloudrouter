...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class VideosKlingApi
    {
        ...
        public VideosKlingApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.KlingVideoGenerationTask?> CreateV1VideosGenerationAsync(Sdkwork.ClawRouter.Open.Models.KlingVideoGenerationRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.KlingVideoGenerationTask>(ApiPaths.AiPath("/kling/v1/videos/generations"), body, null, null, "application/json");
        }

        /// <summary>
        /// Kling retrieve video generation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.KlingVideoGenerationTask?> ListV1VideosGenerationsAsync(string taskId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.KlingVideoGenerationTask>(ApiPaths.AiPath($"/kling/v1/videos/generations/{SerializePathParameter(taskId, new PathParameterSpec("task_id", "simple", false))}"));
        }
