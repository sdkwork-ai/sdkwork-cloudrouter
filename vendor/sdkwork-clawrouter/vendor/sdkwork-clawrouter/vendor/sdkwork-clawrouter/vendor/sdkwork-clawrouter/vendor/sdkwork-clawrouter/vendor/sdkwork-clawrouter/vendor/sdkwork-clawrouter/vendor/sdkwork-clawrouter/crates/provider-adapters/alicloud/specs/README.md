...
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/provider-adapters/alicloud` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/crates/provider-adapters/alicloud/Cargo.toml`
