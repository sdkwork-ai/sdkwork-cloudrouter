...
This directory is the local standards index for `sdkwork-clawrouter-router-service-test-support`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-router-service-test-support` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/crates/sdkwork-clawrouter-router-service-test-support` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
