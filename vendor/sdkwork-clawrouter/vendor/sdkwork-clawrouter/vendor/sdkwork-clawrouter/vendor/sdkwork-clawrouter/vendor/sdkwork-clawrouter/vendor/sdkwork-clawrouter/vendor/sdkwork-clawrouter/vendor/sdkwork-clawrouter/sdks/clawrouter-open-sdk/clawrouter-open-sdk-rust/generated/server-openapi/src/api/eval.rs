...
use crate::models::{
    DeleteResult, OpenAiEval, OpenAiEvalCreateRequest, OpenAiEvalList, OpenAiEvalRun,
    OpenAiEvalRunCreateRequest, OpenAiEvalRunList, OpenAiEvalRunOutputItemList,
...
impl EvalApi {
    ...
    pub async fn list(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiEvalList, SdkworkError> {
    ...
    pub async fn delete(&self, eval_id: &str) -> Result<DeleteResult, SdkworkError> {
        let path = ai_path(&format!(
            "/evals/{}",
            serialize_path_parameter(eval_id, PathParameterSpec::new("eval_id", "simple", false))
        ));
    ...
    pub async fn update(
        &self,
        eval_id: &str,
        body: &OpenAiEvalUpdateRequest,
    ) -> Result<OpenAiEval, SdkworkError> {
        let path = ai_path(&format!(
            "/evals/{}",
            serialize_path_parameter(eval_id, PathParameterSpec::new("eval_id", "simple", false))
        ));
    ...
    pub async fn list_runs(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiEvalRunList, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("limit", limit, "form", true, false, None),
            QueryParameterSpec::new("order", order, "form", true, false, None),
            QueryParameterSpec::new("after", after, "form", true, false, None),
        ...
        let path = append_query_string(
            ai_path(&format!(
                ...
                serialize_path_parameter(
                    eval_id,
                    PathParameterSpec::new("eval_id", "simple", false)
                )
            )),
            &query,
        );
    ...
    pub async fn create_run(
        &self,
        eval_id: &str,
        body: &OpenAiEvalRunCreateRequest,
    ) -> Result<OpenAiEvalRun, SdkworkError> {
        let path = ai_path(&format!(
            "/evals/{}/runs",
            serialize_path_parameter(eval_id, PathParameterSpec::new("eval_id", "simple", false))
        ));
    ...
    pub async fn list_runs_output_items(
        &self,
        eval_id: &str,
        run_id: &str,
        limit: Option<i64>,
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiEvalRunOutputItemList, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("limit", limit, "form", true, false, None),
            QueryParameterSpec::new("order", order, "form", true, false, None),
            QueryParameterSpec::new("after", after, "form", true, false, None),
