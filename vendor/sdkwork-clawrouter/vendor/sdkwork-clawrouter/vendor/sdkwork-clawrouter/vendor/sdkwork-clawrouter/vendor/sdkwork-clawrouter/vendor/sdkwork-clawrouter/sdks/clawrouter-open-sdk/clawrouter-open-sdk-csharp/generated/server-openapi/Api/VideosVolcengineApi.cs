...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class VideosVolcengineApi
    {
        ...
        public VideosVolcengineApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.VolcengineContentGenerationTaskCreateResponse?> CreateApiV3ContentsGenerationsTaskAsync(Sdkwork.ClawRouter.Open.Models.VolcengineContentGenerationTaskCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.VolcengineContentGenerationTaskCreateResponse>(ApiPaths.AiPath("/volcengine/api/v3/contents/generations/tasks"), body, null, null, "application/json");
        }

        /// <summary>
        /// Volcengine Ark retrieve content generation task
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.VolcengineContentGenerationTask?> ListApiV3ContentsGenerationsTasksAsync(string taskId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.VolcengineContentGenerationTask>(ApiPaths.AiPath($"/volcengine/api/v3/contents/generations/tasks/{SerializePathParameter(taskId, new PathParameterSpec("task_id", "simple", false))}"));
        }
