...
Domain: iam
Capability: claw-router-admin-organization
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-clawrouter-pc-admin-organization`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
