...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class FilesAnthropicApi
    {
        ...
        public FilesAnthropicApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.AnthropicFileListResponse?> ListV1FilesAsync(string? beforeId = null, string? afterId = null, int? limit = null)
        {
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.AnthropicFile?> CreateV1FileAsync(Sdkwork.ClawRouter.Open.Models.AnthropicFileUploadMultipartRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.AnthropicFile>(ApiPaths.AiPath("/anthropic/v1/files"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Anthropic delete file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.AnthropicDeleteResponse?> DeleteV1FilesAsync(string fileId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.AnthropicDeleteResponse>(ApiPaths.AiPath($"/anthropic/v1/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }
