...
use crate::models::{
    DeleteResult, OpenAiChatCompletion, OpenAiChatCompletionList, OpenAiChatCompletionMessageList,
    OpenAiChatCompletionRequest, OpenAiChatCompletionUpdateRequest,
};
...
impl ChatApi {
    ...
    pub async fn list(
        ...
        model: Option<&str>,
        metadata: Option<&str>,
    ) -> Result<OpenAiChatCompletionList, SdkworkError> {
    ...
    ) -> Result<OpenAiChatCompletion, SdkworkError> {
    ...
    pub async fn delete(&self, completion_id: &str) -> Result<DeleteResult, SdkworkError> {
        let path = ai_path(&format!(
            ...
            serialize_path_parameter(
                completion_id,
                PathParameterSpec::new("completion_id", "simple", false)
            )
        ));
    ...
    pub async fn update(
        &self,
        completion_id: &str,
        body: &OpenAiChatCompletionUpdateRequest,
    ) -> Result<OpenAiChatCompletion, SdkworkError> {
        let path = ai_path(&format!(
            "/chat/completions/{}",
            serialize_path_parameter(
    ...
    pub async fn list_messages(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiChatCompletionMessageList, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("limit", limit, "form", true, false, None),
            QueryParameterSpec::new("order", order, "form", true, false, None),
            QueryParameterSpec::new("after", after, "form", true, false, None),
