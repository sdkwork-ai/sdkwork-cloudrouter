# sdkwork-clawrouter-router-service-test-support
...
This README is the SDKWork module entrypoint for `sdkwork-clawrouter-router-service-test-support`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/crates/sdkwork-clawrouter-router-service-test-support/Cargo.toml`
