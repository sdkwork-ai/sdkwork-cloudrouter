...
use crate::models::{
    VolcengineContentGenerationTask, VolcengineContentGenerationTaskCreateRequest,
    VolcengineContentGenerationTaskCreateResponse,
};

#[derive(Clone)]
pub struct VideosVolcengineApi {
    client: Arc<SdkworkHttpClient>,
}

impl VideosVolcengineApi {
    pub fn new(client: Arc<SdkworkHttpClient>) -> Self {
        Self { client }
    }

    /// Volcengine Ark content generation task
    pub async fn create_api_v3_contents_generations_task(
        &self,
    ...
    pub async fn list_api_v3_contents_generations_tasks(
        &self,
        task_id: &str,
