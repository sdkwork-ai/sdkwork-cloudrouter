...
cargo test -p sdkwork-clawrouter-admin-api-server --test product_center_routes -- product_center_category_seed_initializer_imports_data_directories_idempotently
```
