...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ImagesMidjourneyApi
    {
        ...
        public ImagesMidjourneyApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.MidjourneyImageGenerationTask?> CreateV1ImagesGenerationAsync(Sdkwork.ClawRouter.Open.Models.MidjourneyImageGenerationRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.MidjourneyImageGenerationTask>(ApiPaths.AiPath("/midjourney/v1/images/generations"), body, null, null, "application/json");
        }

        /// <summary>
        /// Midjourney retrieve image generation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.MidjourneyImageGenerationTask?> ListV1ImagesGenerationsAsync(string taskId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.MidjourneyImageGenerationTask>(ApiPaths.AiPath($"/midjourney/v1/images/generations/{SerializePathParameter(taskId, new PathParameterSpec("task_id", "simple", false))}"));
        }
