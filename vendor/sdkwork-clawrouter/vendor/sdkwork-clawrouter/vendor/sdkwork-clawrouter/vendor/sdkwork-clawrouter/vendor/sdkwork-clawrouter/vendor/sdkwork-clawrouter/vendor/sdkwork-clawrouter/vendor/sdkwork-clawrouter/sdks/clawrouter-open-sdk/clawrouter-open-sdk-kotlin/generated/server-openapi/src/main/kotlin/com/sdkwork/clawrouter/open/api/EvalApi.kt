...
class EvalApi(private val client: HttpClient) {
    ...
    suspend fun list(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiEvalList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiEvalList>() {})
    }

    /** Create eval */
    suspend fun create(body: OpenAiEvalCreateRequest): OpenAiEval? {
        val raw = client.post(ApiPaths.aiPath("/evals"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiEval>() {})
    }

    /** Delete eval */
    suspend fun delete(evalId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve eval */
    suspend fun retrieve(evalId: String): OpenAiEval? {
        val raw = client.get(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<OpenAiEval>() {})
    }

    /** Modify eval */
    suspend fun update(evalId: String, body: OpenAiEvalUpdateRequest): OpenAiEval? {
        val raw = client.post(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiEval>() {})
    }
    ...
    suspend fun listRuns(evalId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiEvalRunList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}/runs"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiEvalRunList>() {})
    }

    /** Create eval run */
    suspend fun createRun(evalId: String, body: OpenAiEvalRunCreateRequest): OpenAiEvalRun? {
        val raw = client.post(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}/runs"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiEvalRun>() {})
    }

    /** Delete eval run */
    suspend fun deleteRuns(evalId: String, runId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}/runs/${serializePathParameter(runId, PathParameterSpec("run_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }
    ...
    suspend fun listRunsOutputItems(evalId: String, runId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiEvalRunOutputItemList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/evals/${serializePathParameter(evalId, PathParameterSpec("eval_id", "simple", false))}/runs/${serializePathParameter(runId, PathParameterSpec("run_id", "simple", false))}/output_items"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiEvalRunOutputItemList>() {})
    }
