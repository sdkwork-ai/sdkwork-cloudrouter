...
This directory is the local standards index for `sdkwork-clawrouter-admin-api-server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-admin-api-server` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/services/sdkwork-clawrouter-admin-api-server` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
