...
type FilesGoogleApi struct {
    client *sdkhttp.Client
}

func NewFilesGoogleApi(client *sdkhttp.Client) *FilesGoogleApi {
    return &FilesGoogleApi{client: client}
}

// Google Gemini list files
func (a *FilesGoogleApi) ListV1betaFiles(pageSize *int, pageToken *string) (sdktypes.GoogleFileListResponse, error) {
    ...
    return decodeResult[sdktypes.GoogleFileListResponse](raw)
}
...
func (a *FilesGoogleApi) CreateV1betaFile(body sdktypes.GoogleFileUploadMultipartRequest) (sdktypes.GoogleFile, error) {
    ...
    return decodeResult[sdktypes.GoogleFile](raw)
}
