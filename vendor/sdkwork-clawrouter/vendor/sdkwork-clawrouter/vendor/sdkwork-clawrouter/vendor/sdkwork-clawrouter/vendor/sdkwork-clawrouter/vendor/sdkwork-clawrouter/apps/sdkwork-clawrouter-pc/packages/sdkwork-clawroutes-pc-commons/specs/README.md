...
This directory is the local standards index for `sdkwork-clawroutes-pc-commons`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawroutes-pc-commons` |
| Type | `node-package` |
| Root | `sdkwork-clawrouter/apps/sdkwork-clawrouter-pc/packages/sdkwork-clawroutes-pc-commons` |
| Domain | `platform` |
| Capability | `router` |
