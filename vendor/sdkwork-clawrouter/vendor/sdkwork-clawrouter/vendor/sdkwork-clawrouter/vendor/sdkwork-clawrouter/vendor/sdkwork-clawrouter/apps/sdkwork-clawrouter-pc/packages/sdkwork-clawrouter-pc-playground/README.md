...
This README is the SDKWork module entrypoint for `sdkwork-clawrouter-pc-playground`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
