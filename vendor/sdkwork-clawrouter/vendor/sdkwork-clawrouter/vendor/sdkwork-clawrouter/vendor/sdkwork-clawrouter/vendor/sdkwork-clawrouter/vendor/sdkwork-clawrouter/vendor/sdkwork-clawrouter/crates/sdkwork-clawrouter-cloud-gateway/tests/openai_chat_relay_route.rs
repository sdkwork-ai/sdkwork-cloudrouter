...
async fn gateway_can_mount_non_stream_chat_completion_relay() {
    ...
    let router =
        sdkwork_clawrouter_cloud_gateway::router_with_product_catalog_api_key_hasher_and_chat_completion_relay(
...
async fn gateway_can_mount_streaming_chat_completion_relay() {
    ...
    let router = sdkwork_clawrouter_cloud_gateway::router_with_product_catalog_api_key_hasher_and_chat_completion_streaming_relay(
        Arc::new(catalog_with_hashed_api_key(key_hash)),
        hasher,
        relay,
    );
