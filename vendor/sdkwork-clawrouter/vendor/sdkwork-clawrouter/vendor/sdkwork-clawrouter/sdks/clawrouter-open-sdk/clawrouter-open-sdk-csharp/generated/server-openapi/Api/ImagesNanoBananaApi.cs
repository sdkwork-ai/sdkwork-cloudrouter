...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ImagesNanoBananaApi
    {
        ...
        public ImagesNanoBananaApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.NanoBananaImageGenerationTask?> CreateGenerationAsync(Sdkwork.ClawRouter.Open.Models.NanoBananaImageGenerationRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.NanoBananaImageGenerationTask>(ApiPaths.AiPath("/nano-banana/v1/images/generations"), body, null, null, "application/json");
        }

        /// <summary>
        /// Nano Banana retrieve image generation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.NanoBananaImageGenerationTask?> RetrieveGenerationAsync(string taskId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.NanoBananaImageGenerationTask>(ApiPaths.AiPath($"/nano-banana/v1/images/generations/{SerializePathParameter(taskId, new PathParameterSpec("task_id", "simple", false))}"));
        }
