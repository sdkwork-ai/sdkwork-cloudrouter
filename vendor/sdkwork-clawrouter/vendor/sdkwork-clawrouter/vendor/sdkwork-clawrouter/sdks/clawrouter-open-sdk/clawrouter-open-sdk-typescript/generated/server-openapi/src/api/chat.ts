...
export interface ChatCompletionsMessagesListParams {
  limit?: number;
  order?: 'asc' | 'desc';
  after?: string;
  before?: string;
...
export class ChatCompletionsMessagesApi {
...
export interface ChatCompletionsListParams {
  limit?: number;
  order?: 'asc' | 'desc';
  after?: string;
  before?: string;
...
export class ChatCompletionsApi {
  private client: HttpClient;
  public readonly messages: ChatCompletionsMessagesApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.messages = new ChatCompletionsMessagesApi(client);
  }
