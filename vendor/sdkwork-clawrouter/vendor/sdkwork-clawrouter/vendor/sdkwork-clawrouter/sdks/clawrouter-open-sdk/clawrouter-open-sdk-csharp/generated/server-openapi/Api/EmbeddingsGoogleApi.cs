...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class EmbeddingsGoogleApi
    {
        ...
        public EmbeddingsGoogleApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleBatchEmbedContentsResponse?> CreateV1betaModelsModelBatchEmbedContentAsync(string model, Sdkwork.ClawRouter.Open.Models.GoogleBatchEmbedContentsRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.GoogleBatchEmbedContentsResponse>(ApiPaths.AiPath($"/google/v1beta/models/{SerializePathParameter(model, new PathParameterSpec("model", "simple", false))}:batchEmbedContents"), body, null, null, "application/json");
        }

        /// <summary>
        /// Google Gemini embed content
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleEmbedContentResponse?> CreateV1betaModelsModelEmbedContentAsync(string model, Sdkwork.ClawRouter.Open.Models.GoogleEmbedContentRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.GoogleEmbedContentResponse>(ApiPaths.AiPath($"/google/v1beta/models/{SerializePathParameter(model, new PathParameterSpec("model", "simple", false))}:embedContent"), body, null, null, "application/json");
        }
