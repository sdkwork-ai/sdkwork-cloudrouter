use sdkwork_clawrouter_settlements_dashboard_repository_sqlx::{
    ...
    SqliteSettlementsDashboardReadStore as RepositorySqliteSettlementsDashboardReadStore,
};
...
#[derive(Debug, Clone)]
pub struct SqliteSettlementsDashboardReadStore(RepositorySqliteSettlementsDashboardReadStore);

impl SqliteSettlementsDashboardReadStore {
    pub fn new(pool: sqlx::SqlitePool) -> Self {
        Self(RepositorySqliteSettlementsDashboardReadStore::new(pool))
    }
}
