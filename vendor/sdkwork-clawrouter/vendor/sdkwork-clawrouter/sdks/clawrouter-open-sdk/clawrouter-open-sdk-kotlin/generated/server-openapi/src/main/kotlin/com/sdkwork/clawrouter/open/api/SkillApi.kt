...
class SkillApi(private val client: HttpClient) {
    ...
    suspend fun list(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiSkillList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/skills"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiSkillList>() {})
    }

    /** Create skill */
    suspend fun create(body: OpenAiSkillCreateMultipartRequest): OpenAiSkill? {
        val raw = client.post(ApiPaths.aiPath("/skills"), body, null, null, "multipart/form-data")
        return client.convertValue(raw, object : TypeReference<OpenAiSkill>() {})
    }

    /** Delete skill */
    suspend fun delete(skillId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve skill */
    suspend fun retrieve(skillId: String): OpenAiSkill? {
        val raw = client.get(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<OpenAiSkill>() {})
    }

    /** Modify skill */
    suspend fun update(skillId: String, body: OpenAiSkillUpdateRequest): OpenAiSkill? {
        val raw = client.post(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiSkill>() {})
    }

    /** Retrieve skill content */
    suspend fun content(skillId: String): String? {
        val raw = client.get(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}/content"))
    ...
    suspend fun listVersions(skillId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiSkillVersionList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}/versions"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiSkillVersionList>() {})
    }

    /** Create skill version */
    suspend fun createVersion(skillId: String, body: OpenAiSkillVersionCreateMultipartRequest): OpenAiSkillVersion? {
        val raw = client.post(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}/versions"), body, null, null, "multipart/form-data")
        return client.convertValue(raw, object : TypeReference<OpenAiSkillVersion>() {})
    }

    /** Delete skill version */
    suspend fun deleteVersions(skillId: String, version: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}/versions/${serializePathParameter(version, PathParameterSpec("version", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve skill version content */
    suspend fun listVersionsContent(skillId: String, version: String): String? {
        val raw = client.get(ApiPaths.aiPath("/skills/${serializePathParameter(skillId, PathParameterSpec("skill_id", "simple", false))}/versions/${serializePathParameter(version, PathParameterSpec("version", "simple", false))}/content"))
        return client.convertValue(raw, object : TypeReference<String>() {})
    }
