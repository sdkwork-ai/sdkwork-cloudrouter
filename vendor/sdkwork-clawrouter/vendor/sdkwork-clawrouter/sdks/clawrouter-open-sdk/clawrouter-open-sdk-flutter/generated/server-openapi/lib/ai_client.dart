...
import 'src/api/eval.dart';
import 'src/api/files.dart';
import 'src/api/fine_tuning.dart';
import 'src/api/images.dart';
import 'src/api/models.dart';
import 'src/api/moderations.dart';
import 'src/api/organization.dart';
import 'src/api/project.dart';
...
class SdkworkAiClient {
  ...
  late final EvalApi eval;
  late final FilesApi files;
  late final FineTuningApi fineTuning;
  ...
  SdkworkAiClient({
    ...
    eval = EvalApi(_httpClient);
    files = FilesApi(_httpClient);
    fineTuning = FineTuningApi(_httpClient);
