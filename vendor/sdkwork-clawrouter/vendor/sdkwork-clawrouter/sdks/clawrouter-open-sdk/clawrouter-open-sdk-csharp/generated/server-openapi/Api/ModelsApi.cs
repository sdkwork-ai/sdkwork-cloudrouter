...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ModelsApi
    {
        ...
        /// List models
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiModelList?> ListAsync()
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiModelList>(ApiPaths.AiPath("/models"));
        }
        ...
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiModel>(ApiPaths.AiPath($"/models/{SerializePathParameter(model, new PathParameterSpec("model", "simple", false))}"));
        }
