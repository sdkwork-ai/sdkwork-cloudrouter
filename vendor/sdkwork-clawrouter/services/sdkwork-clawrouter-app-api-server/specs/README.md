...
This directory is the local standards index for `sdkwork-clawrouter-app-api-server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-app-api-server` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/services/sdkwork-clawrouter-app-api-server` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
