...
This README is the SDKWork module entrypoint for `sdkwork-clawrouter-app-api-server`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/services/sdkwork-clawrouter-app-api-server/Cargo.toml`
