...
This directory is the local standards index for `@sdkwork/commerce-pc-billing`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-billing` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-billing` |
| Domain | `commerce` |
| Capability | `billing` |
...
- `pnpm --filter @sdkwork/commerce-pc-billing typecheck`
