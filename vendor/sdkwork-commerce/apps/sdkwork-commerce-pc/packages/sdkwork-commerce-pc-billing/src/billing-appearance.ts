...
export type SdkworkBillingVisualTone = SdkworkThemeVisualTone;

export function createSdkworkBillingToneStyle(
  tone: SdkworkBillingVisualTone,
  options: {
...
export function createSdkworkBillingPanelStyle(
  tone: SdkworkBillingVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkBillingGlassStyle(
  tone: SdkworkBillingVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkBillingBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkBillingHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkBillingHeroTextStyle(
