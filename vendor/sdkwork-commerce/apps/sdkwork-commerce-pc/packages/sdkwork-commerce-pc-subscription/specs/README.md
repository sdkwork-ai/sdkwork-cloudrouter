...
This directory is the local standards index for `@sdkwork/commerce-pc-subscription`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-subscription` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-subscription` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/commerce-pc-subscription typecheck`
