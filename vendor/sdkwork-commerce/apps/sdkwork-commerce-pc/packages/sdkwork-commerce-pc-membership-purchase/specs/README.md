...
This directory is the local standards index for `@sdkwork/commerce-pc-membership-purchase`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-membership-purchase` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-membership-purchase` |
| Domain | `commerce` |
