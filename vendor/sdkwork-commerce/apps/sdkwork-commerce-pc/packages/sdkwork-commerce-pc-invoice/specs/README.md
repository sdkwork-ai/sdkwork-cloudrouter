...
This directory is the local standards index for `@sdkwork/commerce-pc-invoice`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-invoice` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-invoice` |
| Domain | `commerce` |
| Capability | `invoice` |
...
- `pnpm --filter @sdkwork/commerce-pc-invoice typecheck`
