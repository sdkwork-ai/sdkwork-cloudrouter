...
This directory is the local standards index for `@sdkwork/commerce-pc-points`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-points` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-points` |
| Domain | `commerce` |
| Capability | `points` |
...
- `pnpm --filter @sdkwork/commerce-pc-points typecheck`
