...
This directory is the local standards index for `@sdkwork/commerce-pc-membership`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-membership` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-membership` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/commerce-pc-membership typecheck`
