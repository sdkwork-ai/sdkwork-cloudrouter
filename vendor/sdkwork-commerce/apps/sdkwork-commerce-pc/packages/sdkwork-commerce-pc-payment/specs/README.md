...
This directory is the local standards index for `@sdkwork/commerce-pc-payment`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-payment` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-payment` |
| Domain | `commerce` |
| Capability | `payment` |
...
- `pnpm --filter @sdkwork/commerce-pc-payment typecheck`
