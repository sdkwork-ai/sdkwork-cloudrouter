...
This directory is the local standards index for `@sdkwork/commerce-pc-pricing`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-pricing` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-pricing` |
| Domain | `commerce` |
| Capability | `pricing` |
...
- `pnpm --filter @sdkwork/commerce-pc-pricing typecheck`
