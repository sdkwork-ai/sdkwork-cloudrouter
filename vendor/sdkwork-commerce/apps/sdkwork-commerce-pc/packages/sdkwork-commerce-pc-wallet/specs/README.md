...
This directory is the local standards index for `@sdkwork/commerce-pc-wallet`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-wallet` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-wallet` |
| Domain | `commerce` |
| Capability | `wallet` |
...
- `pnpm --filter @sdkwork/commerce-pc-wallet typecheck`
