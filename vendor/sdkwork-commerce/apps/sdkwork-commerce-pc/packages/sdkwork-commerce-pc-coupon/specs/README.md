...
This directory is the local standards index for `@sdkwork/commerce-pc-coupon`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-coupon` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-coupon` |
| Domain | `commerce` |
| Capability | `coupon` |
...
- `pnpm --filter @sdkwork/commerce-pc-coupon typecheck`
