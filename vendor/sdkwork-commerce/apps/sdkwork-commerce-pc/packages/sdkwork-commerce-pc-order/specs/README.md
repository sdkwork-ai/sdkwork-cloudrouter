...
This directory is the local standards index for `@sdkwork/commerce-pc-order`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-order` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-order` |
| Domain | `commerce` |
| Capability | `order` |
