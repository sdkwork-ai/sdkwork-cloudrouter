...
export type SdkworkOrderVisualTone = SdkworkThemeVisualTone;

export function createSdkworkOrderToneStyle(
...
export function createSdkworkOrderPanelStyle(
  tone: SdkworkOrderVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkOrderGlassStyle(
  tone: SdkworkOrderVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkOrderBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkOrderHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkOrderHeroTextStyle(
