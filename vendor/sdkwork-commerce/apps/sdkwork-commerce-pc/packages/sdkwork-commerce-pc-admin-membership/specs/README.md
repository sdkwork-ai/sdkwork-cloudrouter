...
This directory is the local standards index for `@sdkwork/commerce-pc-admin-membership`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-admin-membership` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-admin-membership` |
| Domain | `commerce` |
