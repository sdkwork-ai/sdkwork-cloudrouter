...
This directory is the local standards index for `@sdkwork/commerce-pc-entitlement`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-entitlement` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-entitlement` |
| Domain | `commerce` |
...
- `pnpm --filter @sdkwork/commerce-pc-entitlement typecheck`
