...
export type SdkworkEntitlementVisualTone = SdkworkThemeVisualTone;

export function createSdkworkEntitlementToneStyle(
  tone: SdkworkEntitlementVisualTone,
  options: {
...
export function createSdkworkEntitlementPanelStyle(
  tone: SdkworkEntitlementVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkEntitlementGlassStyle(
  tone: SdkworkEntitlementVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkEntitlementBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkEntitlementHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkEntitlementHeroTextStyle(
