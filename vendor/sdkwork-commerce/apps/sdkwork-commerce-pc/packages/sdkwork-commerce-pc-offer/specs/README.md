...
This directory is the local standards index for `@sdkwork/commerce-pc-offer`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-offer` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-offer` |
| Domain | `commerce` |
| Capability | `offer` |
...
- `pnpm --filter @sdkwork/commerce-pc-offer typecheck`
