...
This directory is the local standards index for `@sdkwork/commerce-pc-commerce`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-commerce` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-commerce` |
| Domain | `commerce` |
| Capability | `commerce` |
...
- `pnpm --filter @sdkwork/commerce-pc-commerce typecheck`
