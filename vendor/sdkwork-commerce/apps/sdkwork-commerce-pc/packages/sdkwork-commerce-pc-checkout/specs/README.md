...
This directory is the local standards index for `@sdkwork/commerce-pc-checkout`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/commerce-pc-checkout` |
| Type | `react-package` |
| Root | `sdkwork-commerce/apps/sdkwork-commerce-pc/packages/sdkwork-commerce-pc-checkout` |
| Domain | `commerce` |
| Capability | `checkout` |
...
- `pnpm --filter @sdkwork/commerce-pc-checkout typecheck`
