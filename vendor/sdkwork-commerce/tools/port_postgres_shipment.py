#!/usr/bin/env python3
"""Port shipment helpers from sqlite_shipment.rs to postgres_shipment.rs."""
...
SQLITE, POSTGRES = sqlite_postgres_pair("order", "shipment")
...
def port_text(text: str) -> str:
    ...
    text = text.replace("use sqlx::Row;", "use sqlx::{Postgres, Row};")
