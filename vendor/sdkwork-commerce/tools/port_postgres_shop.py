#!/usr/bin/env python3
"""Port shop helpers from sqlite_shop.rs to postgres_shop.rs."""
...
SQLITE, POSTGRES = sqlite_postgres_pair("shop", "shop")
...
def port_text(text: str) -> str:
    ...
    text = text.replace("SqliteCommerceShopStore", "PostgresCommerceShopStore")
