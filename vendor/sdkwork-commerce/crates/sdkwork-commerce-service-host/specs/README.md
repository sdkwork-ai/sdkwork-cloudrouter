...
This directory is the local standards index for `sdkwork_commerce_service_host`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-service-host` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-service-host` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
