# sdkwork-commerce-bootstrap-manifest
...
This README is the SDKWork module entrypoint for `sdkwork-commerce-bootstrap-manifest`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path crates/sdkwork-commerce-bootstrap-manifest/Cargo.toml`
