...
This directory is the local standards index for `sdkwork_commerce_bootstrap_manifest`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-bootstrap-manifest` |
| Type | `tauri-host` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-bootstrap-manifest` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
