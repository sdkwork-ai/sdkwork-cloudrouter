...
This directory is the local standards index for `sdkwork_commerce_tauri_host`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-tauri-host` |
| Type | `tauri-host` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-tauri-host` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-tauri-host/Cargo.toml`
