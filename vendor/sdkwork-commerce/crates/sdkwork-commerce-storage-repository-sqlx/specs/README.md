...
This directory is the local standards index for `sdkwork_commerce_storage_repository_sqlx`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-storage-repository-sqlx` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-storage-repository-sqlx` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
