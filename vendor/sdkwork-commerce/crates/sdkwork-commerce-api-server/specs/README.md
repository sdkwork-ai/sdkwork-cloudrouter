...
This directory is the local standards index for `sdkwork_commerce_api_server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-api-server` |
| Type | `rust-route-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-api-server` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-api-server/Cargo.toml`
