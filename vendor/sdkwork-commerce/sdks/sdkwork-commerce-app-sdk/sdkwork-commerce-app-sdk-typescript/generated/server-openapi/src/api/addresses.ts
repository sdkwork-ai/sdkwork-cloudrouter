...
export class AddressesApi {
  private client: HttpClient;
  public readonly defaultSelection: AddressesDefaultSelectionApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.defaultSelection = new AddressesDefaultSelectionApi(client);
  }


/** Addresses list. */
  async list(params?: AddressesListParams): Promise<CommerceApiResult> {
...
export function createAddressesApi(client: HttpClient): AddressesApi {
  return new AddressesApi(client);
}
