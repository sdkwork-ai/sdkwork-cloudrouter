...
/** Recharges settings retrieve. */
  async retrieve(): Promise<CommerceApiResult> {
    return this.client.request<CommerceApiResult>(appApiPath(`/recharges/settings`), { method: 'GET' as any, skipAuth: true });
  }
}
...
/** Recharges packages list. */
  async list(params?: RechargesPackagesListParams): Promise<CommerceApiResult> {
    ...
    return this.client.request<CommerceApiResult>(appendQueryString(appApiPath(`/recharges/packages`), query), { method: 'GET' as any, skipAuth: true });
  }
}
