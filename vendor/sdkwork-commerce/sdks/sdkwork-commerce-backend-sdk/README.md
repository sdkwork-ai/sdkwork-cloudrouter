...
SDK family: `sdkwork-commerce-backend-sdk`
API authority: `sdkwork-commerce-backend-api`
API prefix: `/backend/v3/api`
Audience: backend-admin
Generated languages: typescript, rust, java, python, go
Status: standardized
