...
This directory is the local SDKWork component contract for `sdkwork-commerce-backend-sdk`.

- Component root: `sdkwork-commerce/sdks/sdkwork-commerce-backend-sdk`
