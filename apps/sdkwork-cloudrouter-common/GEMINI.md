...
This file is a compatibility shim for Gemini CLI inside the shared Cloud Router client family application root. The authoritative SDKWork agent entrypoint is `AGENTS.md` in this same directory.
