...
/// Authored message keys for the api_keys capability.
///
...
class ConsoleApiKeysMessages {
  const ConsoleApiKeysMessages._();

  static const String titleKey = 'cloudrouter.console.apiKeys.title';
