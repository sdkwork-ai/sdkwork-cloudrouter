...
/// Authored message keys for the dashboard capability.
///
...
class ConsoleDashboardMessages {
  const ConsoleDashboardMessages._();

  static const String titleKey = 'cloudrouter.console.dashboard.title';
