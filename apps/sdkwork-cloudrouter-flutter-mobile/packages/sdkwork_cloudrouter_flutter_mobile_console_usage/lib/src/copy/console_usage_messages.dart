...
/// Authored message keys for the usage capability.
///
...
class ConsoleUsageMessages {
  const ConsoleUsageMessages._();

  static const String titleKey = 'cloudrouter.console.usage.title';
