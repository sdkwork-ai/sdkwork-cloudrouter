...
function assertPortalCommandShims() {
  ...
  if (!commandShims.some((commandShim) => existsSync(commandShim))) {
    throw new Error(
      'Portal dependency command shims are not installed: vite. Run pnpm install in apps/sdkwork-cloudrouter-pc or start with pnpm --dir apps/sdkwork-cloudrouter-pc install.',
    );
  }
}
