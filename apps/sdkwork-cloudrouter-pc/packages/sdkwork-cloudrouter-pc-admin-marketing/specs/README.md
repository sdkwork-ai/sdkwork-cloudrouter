# SDKWork Cloud Router Admin Marketing Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-marketing`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-marketing` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-marketing` |
| Domain | `promotion` |
...
- `@sdkwork/cloudrouter-backend-sdk` for Cloud Router promotion extensions.
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-marketing typecheck`
