# SDKWork Cloud Router Admin Ratelimit Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-ratelimit`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-ratelimit` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-ratelimit` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-ratelimit typecheck`
