# SDKWork Cloud Router Console Core Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-console-core`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-console-core` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-console-core` |
| Domain | `platform` |
| Capability | `router` |
