# SDKWork Cloud Router Home Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-home`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-home` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-home` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-home typecheck`
