# SDKWork Cloud Router Console User Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-console-user`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-console-user` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-console-user` |
| Domain | `iam` |
| Capability | `user` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-console-user typecheck`
