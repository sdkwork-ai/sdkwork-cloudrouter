...
import { Footer, Navbar } from '@sdkwork/cloudroutes-pc-commons';
...
export function RouteFallback() {
  ...
  if (pathname.startsWith('/auth')) {
    return (
      <div className="sdkwork-auth-route-fallback sdkwork-cloudrouter-auth-route-fallback fixed inset-0 z-[60] h-[100dvh] min-h-[100dvh] w-full" />
    );
  }
  ...
  return (
    <>
      ...
      <div
        ...
        className={
          isPlayground
            ? 'sdkwork-cloudrouter-playground-host-offset flex-1'
            : usesPortalHostOffset
              ? 'sdkwork-cloudrouter-documents-host-offset flex-1'
              : 'flex-1'
        }
      >
        <Routes>
