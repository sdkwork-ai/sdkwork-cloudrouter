# sdkwork-cloudrouter-pc-admin-dashboard
...
This README is the SDKWork module entrypoint for `sdkwork-cloudrouter-pc-admin-dashboard`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
