...
export class AdminDashboardService {
  static async fetchDashboardData(
    ...
    const result = await getCloudRouterBackendSdkClient().system.dashboard.admin.overview.retrieve();
  ...
  static async fetchInstallationStatus(): Promise<InstallationStatusResponse> {
    const result = await getCloudRouterBackendSdkClient().system.installation.status.retrieve();
...
async function fetchDailyDashboardAnalytics(): Promise<DashboardAnalyticsSnapshot> {
  const result = await getCloudRouterBackendSdkClient().system.analytics.admin.overview.retrieve({
