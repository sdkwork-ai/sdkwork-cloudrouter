# SDKWork Cloud Router Admin Dashboard Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-dashboard` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-dashboard` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-dashboard typecheck`
