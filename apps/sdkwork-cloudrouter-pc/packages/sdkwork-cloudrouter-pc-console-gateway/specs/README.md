# SDKWork Cloud Router Console Gateway Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-console-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-console-gateway` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-console-gateway` |
| Domain | `platform` |
| Capability | `router` |
