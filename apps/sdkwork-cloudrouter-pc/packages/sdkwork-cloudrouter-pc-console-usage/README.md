...
This README is the SDKWork module entrypoint for `sdkwork-cloudrouter-pc-console-usage`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
