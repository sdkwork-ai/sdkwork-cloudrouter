# SDKWork Cloud Router Admin Service Nodes Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-service-nodes`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-service-nodes` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-service-nodes` |
| Domain | `platform` |
| Capability | `router` |
