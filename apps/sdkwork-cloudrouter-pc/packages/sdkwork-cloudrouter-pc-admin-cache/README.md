# sdkwork-cloudrouter-pc-admin-cache
...
This README is the SDKWork module entrypoint for `sdkwork-cloudrouter-pc-admin-cache`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
