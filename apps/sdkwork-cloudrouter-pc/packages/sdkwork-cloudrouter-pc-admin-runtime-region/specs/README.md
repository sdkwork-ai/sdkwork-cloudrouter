# SDKWork Cloud Router Admin Runtime Region Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-runtime-region`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-runtime-region` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-runtime-region` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-runtime-region typecheck`
