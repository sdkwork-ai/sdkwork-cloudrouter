# SDKWork Cloud Router Admin Record Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-record`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-record` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-record` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-record typecheck`
