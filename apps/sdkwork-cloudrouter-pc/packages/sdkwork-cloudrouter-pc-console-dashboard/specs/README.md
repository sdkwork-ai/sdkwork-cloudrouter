# SDKWork Cloud Router Console Dashboard Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-console-dashboard`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-console-dashboard` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-console-dashboard` |
| Domain | `platform` |
| Capability | `router` |
