...
const DEFAULT_NOTIFICATION_APP_ID = 'cloud-router';
...
export function getPortalNotificationClient(): PortalNotificationClient {
  return createPortalNotificationSdkClient(getCloudRouterAppSdkClient());
}

function createPortalNotificationSdkClient(
  appSdkClient: ReturnType<typeof getCloudRouterAppSdkClient>,
