...
function readCloudRouterDomainSessionTokens() {
...
export function configureCloudRouterDomainServiceProviders(): void {
  const readSessionTokens = readCloudRouterDomainSessionTokens;
...
export function getCloudRouterMembershipCheckoutService(): SdkworkMembershipCheckoutService {
  if (!membershipCheckoutService) {
    throw new Error('Cloud Router membership checkout service is not configured.');
  }
...
export function getCloudRouterPointsRechargeService(): SdkworkPointsRechargeService {
  if (!pointsRechargeService) {
    throw new Error('Cloud Router Compute Credits recharge service is not configured.');
  }
  return pointsRechargeService;
}

export function getCloudRouterCouponRechargeService(): SdkworkCouponRechargeService {
  if (!couponRechargeService) {
    throw new Error('Cloud Router coupon recharge service is not configured.');
  }
