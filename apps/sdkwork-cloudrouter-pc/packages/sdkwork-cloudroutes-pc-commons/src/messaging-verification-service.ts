...
export interface CloudRouterMessagingVerificationService {
  verificationCodes: {
...
export interface CreateCloudRouterMessagingVerificationServiceOptions {
...
let sharedMessagingVerificationService: CloudRouterMessagingVerificationService | null = null;

export function createCloudRouterMessagingVerificationService(
  options: CreateCloudRouterMessagingVerificationServiceOptions = {},
): CloudRouterMessagingVerificationService {
...
export function getCloudRouterMessagingVerificationService(): CloudRouterMessagingVerificationService {
  sharedMessagingVerificationService ??= createCloudRouterMessagingVerificationService();
  return sharedMessagingVerificationService;
}

export function resetCloudRouterMessagingVerificationService(): void {
