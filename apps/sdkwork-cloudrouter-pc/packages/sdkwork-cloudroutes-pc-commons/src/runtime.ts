import { appApiPath } from '@sdkwork/cloudrouter-app-sdk';
import type { CloudRouterAppSdkClient } from './sdk-clients.ts';
...
export async function* streamRuntimeInvocationEvents(
  client: CloudRouterAppSdkClient,
  invocationId: string,
  afterEventNo = 0,
