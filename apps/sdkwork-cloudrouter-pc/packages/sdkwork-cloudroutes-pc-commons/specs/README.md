# SDKWork Cloud Router Commons Component Specs

This directory is the local standards index for `sdkwork-cloudroutes-pc-commons`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudroutes-pc-commons` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudroutes-pc-commons` |
| Domain | `platform` |
| Capability | `router` |
