# SDKWork Cloud Router Models Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-models`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-models` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-models` |
| Domain | `intelligence` |
| Capability | `model` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-models typecheck`
