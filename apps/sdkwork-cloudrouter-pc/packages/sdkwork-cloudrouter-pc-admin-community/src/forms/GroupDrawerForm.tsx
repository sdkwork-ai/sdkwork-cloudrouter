    ...
    <CommunityFormFrame error={error} formId="community-group-form" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 rounded-md border border-dashed border-slate-300 px-3 py-2 text-xs font-medium text-slate-500 hover:border-slate-400 hover:text-slate-700 dark:border-white/20 dark:text-slate-400"
        >
