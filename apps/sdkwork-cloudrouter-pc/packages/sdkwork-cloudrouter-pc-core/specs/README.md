# SDKWork Cloud Router Core Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-core`.
...
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-core` |
| Domain | `platform` |
| Capability | `router` |
