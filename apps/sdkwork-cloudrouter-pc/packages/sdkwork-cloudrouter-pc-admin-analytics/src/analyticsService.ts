...
import { optionalText } from '@sdkwork/cloudroutes-pc-commons/sdk-request-boundary';
...
export class AdminAnalyticsService {
  static async fetchOverview(query: AdminAnalyticsQuery = {}): Promise<AdminAnalyticsOverview> {
    ...
    const result = await getCloudRouterBackendSdkClient().system.analytics.admin.overview.retrieve(params);
