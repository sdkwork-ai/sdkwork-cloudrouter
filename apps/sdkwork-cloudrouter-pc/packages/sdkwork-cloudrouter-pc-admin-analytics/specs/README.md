# SDKWork Cloud Router Admin Analytics Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-analytics`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-analytics` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-analytics` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-analytics typecheck`
