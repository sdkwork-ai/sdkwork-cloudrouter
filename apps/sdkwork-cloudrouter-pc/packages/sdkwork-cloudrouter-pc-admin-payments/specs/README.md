# SDKWork Cloud Router Admin Payments Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-payments`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-payments` |
| Type | `react-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-payments` |
| Domain | `payment` |
| Capability | `payment` |
...
- `@sdkwork/cloudrouter-backend-sdk` for Cloud Router-owned payment extensions.

The provider-account surface composes the public
`@sdkwork/payment-pc-admin-provider` package. It does not copy Payment DTOs,
credential forms, transports, or generated SDK code into Cloud Router.
