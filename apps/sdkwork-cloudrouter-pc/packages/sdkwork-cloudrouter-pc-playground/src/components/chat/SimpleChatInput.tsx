...
const FALLBACK_CHAT_MODEL = createFallbackModel('Chat model', 'Chat model catalog is being prepared', 'AI', 'llms', 'Cloud Router');
const SIMPLE_CHAT_SELECTED_MODEL_STORAGE_KEY = 'sdkwork-cloudrouter.playground.chat.selectedModelId';
