# SDKWork Cloud Router Playground Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-playground`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-playground` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-playground` |
| Domain | `platform` |
| Capability | `router` |
