...
export const playgroundGenerationMessages = {
  ...
  zh: {
    ...
    "playground.generationCost.estimated": "预计消耗算力积分",
    "playground.generationCost.unavailable": "按实际结算",
    "playground.generationCost.reference": "参考价",
    "playground.generationCost.settlement": "最终算力积分以模型路由和 Token Bank 结算为准。",
    "playground.generationCost.points": "{{points}} 算力积分",
