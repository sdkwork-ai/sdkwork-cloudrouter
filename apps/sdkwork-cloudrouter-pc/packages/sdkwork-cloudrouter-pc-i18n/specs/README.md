# SDKWork Cloud Router I18n Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-i18n` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-i18n` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-i18n typecheck`
