# SDKWork Cloud Router Console Settings Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-console-settings`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-console-settings` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-console-settings` |
| Domain | `platform` |
| Capability | `router` |
