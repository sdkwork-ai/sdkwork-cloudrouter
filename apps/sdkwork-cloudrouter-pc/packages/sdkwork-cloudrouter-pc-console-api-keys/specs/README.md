# SDKWork Cloud Router Console API Keys Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-console-api-keys`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-console-api-keys` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-console-api-keys` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-console-api-keys typecheck`
