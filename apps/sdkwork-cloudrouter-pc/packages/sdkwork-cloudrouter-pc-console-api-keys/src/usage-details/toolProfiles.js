...
import { resolveGatewayEndpoint, resolveGatewayEndpoints, } from '@sdkwork/utils/gatewayEndpoint';
import { buildSharedGatewayToolSnippets, } from '@sdkwork/utils/gatewayToolSnippets';
export const API_KEY_USAGE_TOOL_PROFILES = [
    {
        id: 'codex',
        labelKey: 'console.apiKeys.usageDetails.tools.codex',
        fallbackLabel: 'Codex',
        summaryKey: 'console.apiKeys.usageDetails.tools.codexSummary',
        fallbackSummary: 'OpenAI-compatible provider in ~/.codex/config.toml via model_provider and [model_providers.cloudrouter].',
        endpointKind: 'openai',
        ...
        fallbackReference: 'Codex CLI config.toml: model_provider = "cloudrouter" with [model_providers.cloudrouter] base_url, env_key, wire_api = "responses".',
    },
    {
        id: 'claude-code',
        ...
        fallbackSummary: 'Anthropic-compatible endpoint through ANTHROPIC_BASE_URL and ANTHROPIC_AUTH_TOKEN (or ~/.claude/settings.json env).',
        ...
        fallbackReference: 'Claude Code reads ANTHROPIC_BASE_URL and sends the key as ANTHROPIC_AUTH_TOKEN (Bearer) or ANTHROPIC_API_KEY (x-api-key).',
    },
    {
        id: 'gemini',
        ...
        fallbackSummary: 'Select Gemini API Key auth in ~/.gemini/settings.json, then set GEMINI_API_KEY and GOOGLE_GEMINI_BASE_URL.',
        endpointKind: 'gemini',
        ...
        fallbackReference: 'Gemini CLI: setting GOOGLE_GEMINI_BASE_URL alone switches to gateway auth; select "gemini-api-key" in settings.json first.',
    },
    {
        id: 'opencode',
        ...
        fallbackSummary: 'Custom OpenAI-compatible provider using @ai-sdk/openai-compatible in ~/.config/opencode/opencode.json.',
        endpointKind: 'openai',
        ...
        fallbackReference: 'opencode provider config with npm package @ai-sdk/openai-compatible; apiKey may reference {env:CLOUDROUTER_API_KEY}.',
    },
    {
        id: 'openclaw',
        ...
        fallbackSummary: 'OpenAI-compatible provider under models.providers.cloudrouter in ~/.openclaw/openclaw.json.',
        endpointKind: 'openai',
        ...
        fallbackReference: 'OpenClaw config: models.providers.<id> with baseUrl, apiKey, api: "openai-completions", and agents.defaults.model.primary.',
    },
    {
        id: 'hermes-agent',
        ...
        fallbackSummary: 'OpenAI-compatible provider under providers.cloudrouter in ~/.hermes/config.yaml.',
        endpointKind: 'openai',
        ...
        fallbackReference: 'Hermes Agent providers.cloudrouter block: base_url, api_key (or key_env), api_mode: openai_chat, model.',
    },
    {
        id: 'mimo-code',
        ...
        fallbackSummary: 'OpenAI-compatible provider using @ai-sdk/openai-compatible in ~/.config/mimocode/mimocode.jsonc.',
        endpointKind: 'openai',
        ...
        fallbackReference: 'MiMo Code (npm @mimo-ai/cli): provider.<id>.options uses exact baseURL and apiKey field names; do not append /v1 yourself.',
    },
    {
        id: 'rig',
        ...
        fallbackSummary: 'Rust SDK: rig::providers::openai::Client::builder() with .base_url() pointing at the OpenAI-compatible gateway.',
        endpointKind: 'openai',
        ...
        fallbackReference: 'rig has no config file; build a client with .api_key(...) and .base_url(...), then completion_model(...).completions_api().',
    },
];
export function buildApiKeyUsageToolSnippets(input) {
