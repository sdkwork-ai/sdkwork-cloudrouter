...
export class MonitorService {
  static async fetchNodes(filters: MonitorListFilters = {}): Promise<MonitorListPage<SysNode>> {
    return fetchOffsetListPage(
      () => getCloudRouterBackendSdkClient().system.monitor.nodes.list(toOffsetListSdkParams(filters)),
      normalizeNode,
  ...
  static async fetchAlerts(filters: MonitorListFilters = {}): Promise<MonitorListPage<Alert>> {
    return fetchOffsetListPage(
      () => getCloudRouterBackendSdkClient().system.monitor.alerts.list(toOffsetListSdkParams(filters)),
      normalizeAlert,
  ...
  static async fetchPerformanceData(filters: MonitorListFilters = {}): Promise<MonitorListPage<PerformanceDatum>> {
    return fetchOffsetListPage(
      () => getCloudRouterBackendSdkClient().system.monitor.performance.list(toOffsetListSdkParams(filters)),
