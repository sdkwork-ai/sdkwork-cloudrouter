# SDKWork Cloud Router Admin Monitor Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-monitor`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-monitor` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-monitor` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-admin-monitor typecheck`
