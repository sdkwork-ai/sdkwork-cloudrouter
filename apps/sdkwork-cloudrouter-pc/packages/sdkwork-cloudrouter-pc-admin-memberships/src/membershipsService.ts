...
async function backendMembershipsRechargePackagesCreate(
  ...
  return getCloudRouterBackendSdkClient().recharges.packages.create(body);
}
...
async function backendMembershipsRechargePackagesUpdate(
  ...
  return getCloudRouterBackendSdkClient().recharges.packages.update(
    packageId,
    body,
  );
}
...
async function backendMembershipsRechargePackagesDelete(
  ...
  return getCloudRouterBackendSdkClient().recharges.packages.delete(
    packageId,
  );
}

async function backendMembershipsRechargeSettingsRetrieve() {
  return getCloudRouterBackendSdkClient().recharges.settings.retrieve();
}
