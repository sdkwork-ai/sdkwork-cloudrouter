# SDKWork Cloud Router Admin Memberships Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-admin-memberships`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-admin-memberships` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-memberships` |
| Domain | `membership` |
...
- `@sdkwork/cloudrouter-backend-sdk` for the Cloud Router recharge extension.
