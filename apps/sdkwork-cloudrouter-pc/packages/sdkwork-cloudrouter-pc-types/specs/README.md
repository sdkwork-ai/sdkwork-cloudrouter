# SDKWork Cloud Router Types Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-types`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-types` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-types` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-types typecheck`
