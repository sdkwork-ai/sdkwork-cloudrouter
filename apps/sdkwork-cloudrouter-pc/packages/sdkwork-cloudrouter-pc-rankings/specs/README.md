# SDKWork Cloud Router Rankings Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc-rankings`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc-rankings` |
| Type | `node-package` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-rankings` |
| Domain | `platform` |
| Capability | `router` |
...
- `pnpm --filter sdkwork-cloudrouter-pc-rankings typecheck`
