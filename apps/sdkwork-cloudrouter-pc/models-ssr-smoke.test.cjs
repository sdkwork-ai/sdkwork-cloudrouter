...
function installSsrRequireHooks() {
  ...
  const shims = new Map([
    ...
    ['sdkwork-cloudroutes-pc-commons', createCommonsShim()],
  ]);
...
const { ModelDetails } = require('./packages/sdkwork-cloudrouter-pc-models/src/pages/ModelDetails.tsx');
const { Models } = require('./packages/sdkwork-cloudrouter-pc-models/src/pages/Models.tsx');
