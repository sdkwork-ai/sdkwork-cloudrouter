...
const CHAT_FILES = [
  ...
  './packages/sdkwork-cloudrouter-pc-playground/src/components/chat/SimpleChatInput.tsx',
  './packages/sdkwork-cloudrouter-pc-playground/src/components/chat/ChatMessageBubble.tsx',
  './packages/sdkwork-cloudrouter-pc-playground/src/components/chat/ChatMessageList.tsx',
  './packages/sdkwork-cloudrouter-pc-playground/src/components/chat/ChatSessionList.tsx',
];
