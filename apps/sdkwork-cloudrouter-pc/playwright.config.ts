...
/**
 * Playwright E2E configuration for the SDKWork CloudRouter PC portal.
 *
 ...
 *
 * Run locally:
 *   pnpm --dir apps/sdkwork-cloudrouter-pc test:e2e
 *
 * Run a single spec:
 *   pnpm --dir apps/sdkwork-cloudrouter-pc exec playwright test e2e/theme-switch.spec.ts
 */
