# SDKWork CloudRouter PC Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-pc`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-pc` |
| Type | `react-app` |
| Root | `sdkwork-cloudrouter/apps/sdkwork-cloudrouter-pc` |
| Domain | `platform` |
| Capability | `router` |
