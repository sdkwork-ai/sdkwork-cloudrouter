...
import { RateLimitService } from "./packages/sdkwork-cloudrouter-pc-admin-ratelimit/src/ratelimitService.ts";
import {
  createFirewallInputFromForm,
  createIpLimitInputFromForm,
  createModelLimitInputFromForm,
  createTokenLimitInputFromForm,
} from "./packages/sdkwork-cloudrouter-pc-admin-ratelimit/src/ratelimitForm.ts";
...
test("admin ratelimit modals expose browser constraints matching backend positive integer commands", () => {
  const source = readFileSync(
    new URL("./packages/sdkwork-cloudrouter-pc-admin-ratelimit/src/index.tsx", import.meta.url),
    "utf8",
  );
...
test("admin ratelimit page does not expose unsupported row menus and dashboard loads backend rule aggregates", () => {
  ...
  const querySource = readFileSync(
    new URL("./packages/sdkwork-cloudrouter-pc-admin-ratelimit/src/ratelimitQueries.ts", import.meta.url),
    "utf8",
  );
