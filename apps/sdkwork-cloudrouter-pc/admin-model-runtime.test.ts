...
test("admin model page visible copy uses the admin model i18n namespace", () => {
  ...
  const i18nSource = readFileSync(
    resolve(PORTAL_ROOT, "packages/sdkwork-cloudrouter-pc-i18n/src/resources/admin/model.ts"),
    "utf8",
  );
...
test("admin model resource management is registered as a model management menu route", () => {
  const adminHostSource = readFileSync(resolve(PORTAL_ROOT, "src/admin/cloudRouterAdminHostMount.tsx"), "utf8");
  const registrySource = readFileSync(resolve(PORTAL_ROOT, "packages/sdkwork-cloudrouter-pc-admin-shell/src/adminModuleRegistry.ts"), "utf8");
  const packageSource = readFileSync(
    resolve(PORTAL_ROOT, "../../../sdkwork-models/apps/sdkwork-models-pc/packages/sdkwork-models-pc-admin-catalog/src/index.tsx"),
    "utf8",
  );
  const navSource = readFileSync(
    resolve(PORTAL_ROOT, "packages/sdkwork-cloudrouter-pc-i18n/src/resources/admin/core-navigation.ts"),
    "utf8",
  );
...
test("shared AI resource selector keeps server search, pagination, cancel, and confirm distinct", () => {
  const source = readFileSync(
    resolve(PORTAL_ROOT, "packages/sdkwork-cloudroutes-pc-commons/src/components/AiResourceSelectorModal.tsx"),
    "utf8",
  );
