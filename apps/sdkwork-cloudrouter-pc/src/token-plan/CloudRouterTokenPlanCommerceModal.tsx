...
export function createTokenPlanCommerceModal(variant: TokenPlanCommerceModalVariant) {
  return function TokenPlanCommerceModal(props: SdkworkSubscriptionCatalogModalProps) {
    return <CloudRouterTokenPlanCommerceModal {...props} variant={variant} />;
  };
}

export const CloudRouterTokenPlanTokenBankDetailsModal = createTokenPlanCommerceModal("token-bank-details");
export function CloudRouterTokenPlanRedeemModal({
  isOpen,
  onClose,
  ...
  return (
    <SdkworkCouponRedemptionDialog
      ...
      service={getCloudRouterCouponRechargeService()}
    />
  );
}

export function CloudRouterTokenPlanCheckoutModal({
  isOpen,
  onClose,
  onPaymentCompleted,
  onPaymentStatus,
...
export function CloudRouterTokenPlanTokenBankPurchaseModal({
  ...
  return (
    <SdkworkPointsRechargeDialog
      ...
      isOpen={isOpen}
      onClose={onClose}
      service={getCloudRouterPointsRechargeService()}
    />
  );
}

function CloudRouterTokenPlanCommerceModal({
  isOpen,
  onClose,
  variant,
