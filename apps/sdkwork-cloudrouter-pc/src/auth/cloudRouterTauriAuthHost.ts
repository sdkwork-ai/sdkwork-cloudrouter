...
export const cloudRouterTauriAuthHostBridge = createTauriHostBridge({
  descriptor: {
    id: 'cloud-router-auth-tauri-host',
    label: 'Cloud Router Auth Tauri Host',
    windowChrome: {
      decorations: true,
      dragRegion: false,
...
export const cloudRouterTauriAuthHostReadiness = evaluateTauriHostBridgeReadiness(
  cloudRouterTauriAuthHostBridge,
  {
    requiredCapabilities: ['theme-sync'],
  },
);

export const cloudRouterTauriAuthHostPackageMeta = hostTauriPackageMeta;
