...
import {
  ...
  getCloudRouterMessagingVerificationService,
...
export function getCloudRouterAuthRuntime(): SdkworkIamRuntimeAuthRuntimeLike {
  const runtime = getCloudRouterIamRuntime();
  ...
  return {
    ...
    service: {
      ...
      messaging: getCloudRouterMessagingVerificationService(),
      oauth: {
