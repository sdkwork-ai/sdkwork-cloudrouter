...
import {
  ...
  type CloudRouterConsoleBusinessHostConfig,
  type CloudRouterConsoleBusinessHostPaths,
} from './consoleBusinessConfig.ts';

export interface CloudRouterConsoleBusinessNavigation
  extends CloudRouterConsoleBusinessHostPaths {
  onNavigate: (route: string) => void;
  paths: CloudRouterConsoleBusinessHostPaths;
}

export function mapConsoleBusinessRouteToHost(
  route: string,
  config?: CloudRouterConsoleBusinessHostConfig,
): string {
...
export function useConsoleBusinessNavigation(
  config?: CloudRouterConsoleBusinessHostConfig,
): CloudRouterConsoleBusinessNavigation {
