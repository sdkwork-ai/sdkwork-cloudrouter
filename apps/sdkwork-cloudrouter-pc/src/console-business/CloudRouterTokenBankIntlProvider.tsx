...
interface CloudRouterTokenBankIntlProviderProps extends PropsWithChildren {
  locale: string;
}

export function CloudRouterTokenBankIntlProvider({
  children,
  locale,
}: CloudRouterTokenBankIntlProviderProps) {
