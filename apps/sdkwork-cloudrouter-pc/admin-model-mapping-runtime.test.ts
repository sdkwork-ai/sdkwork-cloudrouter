...
test('admin model mapping page exposes route, navigation, and core layout markers', () => {
  ...
  const coreI18nSource = readPortalFile('packages/sdkwork-cloudrouter-pc-i18n/src/resources/admin/core-navigation.ts');
  const modelI18nSource = readPortalFile('packages/sdkwork-cloudrouter-pc-i18n/src/resources/admin/model.ts');
