...
This file is a compatibility shim for Claude Code inside the HarmonyOS Mobile application root. The authoritative SDKWork agent entrypoint is `AGENTS.md` in this same directory.
