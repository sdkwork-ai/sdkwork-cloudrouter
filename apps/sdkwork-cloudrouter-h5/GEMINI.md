...
This file is a compatibility shim for Gemini CLI inside the H5 application root. The authoritative SDKWork agent entrypoint is `AGENTS.md` in this same directory.
