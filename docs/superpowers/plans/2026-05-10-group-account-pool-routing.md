...
**Files:**
- Modify: `services/sdkwork-cloudrouter-router-service/tests/openai_chat_api.rs`
...
**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/domain/routing.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/domain/mod.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/ports/pricing_catalog.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/in_memory_pricing_catalog.rs`
...
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/catalog.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/sqlite/row_mapping.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/postgres/row_mapping.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/sqlite/loader.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/postgres/loader.rs`
...
**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/provider_route_selector.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/mod.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/api/openai_runtime.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test openai_chat_api --offline`.
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test sql_pricing_catalog_contract --offline`.
