...
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Replace: `services/sdkwork-cloudrouter-edge-runtime/src/openai_route_taxonomy.rs` usage with product-layer classifier
...
- Move logic from: `services/sdkwork-cloudrouter-edge-runtime/src/route_scoped_openai_passthrough.rs`
...
**Files:**
- Create: `services/sdkwork-cloudrouter-edge-runtime/src/invocation_http.rs`
- Create: `services/sdkwork-cloudrouter-edge-runtime/src/invocation_router.rs`
- Modify: `services/sdkwork-cloudrouter-edge-runtime/src/lib.rs`
- Modify: `services/sdkwork-cloudrouter-edge-runtime/src/runtime.rs`
- Test: `services/sdkwork-cloudrouter-edge-runtime/tests/invocation_router.rs`
...
- Delete or replace: `services/sdkwork-cloudrouter-edge-runtime/src/passthrough.rs`
- Delete or replace: `services/sdkwork-cloudrouter-edge-runtime/src/route_scoped_openai_passthrough.rs`
...
**Files:**
- Modify/add gateway tests under `services/sdkwork-cloudrouter-edge-runtime/tests/`
