...
**Files:**
- Modify: `services/sdkwork-clawrouter-edge-runtime/tests/edge_server.rs`
...
Modify `services/sdkwork-clawrouter-edge-runtime/src/edge_server.rs` to add `EdgeInProcessUpstreams` and a new router constructor. Dispatch matching API paths through cloned Axum routers with `tower::ServiceExt::oneshot`; keep existing HTTP forwarding as the default.
...
**Files:**
- Modify: `services/sdkwork-clawrouter-edge-runtime/Cargo.toml`
- Modify: `services/sdkwork-clawrouter-edge-runtime/src/lib.rs`
- Modify: `services/sdkwork-clawrouter-edge-runtime/src/main.rs`
