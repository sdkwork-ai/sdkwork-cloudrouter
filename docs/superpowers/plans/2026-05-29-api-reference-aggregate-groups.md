...
- [ ] **Step 2: Run focused Node test to verify RED**
  Run: `pnpm.cmd --dir apps\sdkwork-cloudrouter-pc exec tsx api-reference-playground-runtime.test.ts`
...
- Modify: `apps/sdkwork-cloudrouter-pc/scripts/smoke-production-browser.mjs`
...
- [ ] **Step 2: Run focused Rust test to verify RED**
  Run: `cargo test -p sdkwork-cloudrouter-http service_router_exposes_ordered_openapi_schema_tabs_from_route_config`
...
- [ ] Run `pnpm.cmd --dir apps\sdkwork-cloudrouter-pc exec tsx api-reference-playground-runtime.test.ts`
- [ ] Run `cargo test -p sdkwork-cloudrouter-http service_router_exposes_ordered_openapi_schema_tabs_from_route_config`
- [ ] Run `cargo test -p sdkwork-cloudrouter-edge-runtime edge_server_serves_portal_assets_and_openapi_contracts`
- [ ] Run `pnpm.cmd --dir apps\sdkwork-cloudrouter-pc typecheck`
