...
```text
services/sdkwork-clawrouter-cloud-gateway/src/invocation_http.rs
services/sdkwork-clawrouter-cloud-gateway/src/invocation_router.rs
```
...
services/sdkwork-clawrouter-cloud-gateway/src/passthrough.rs
services/sdkwork-clawrouter-cloud-gateway/src/route_scoped_openai_passthrough.rs
```
