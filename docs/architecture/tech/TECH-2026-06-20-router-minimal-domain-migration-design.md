...
This unimplemented proposal instructed Cloud Router to delete Chat persistence
...
For Chat, Cloud Router currently owns the eight-table PostgreSQL authority
