> Migrated from `docs/superpowers/plans/2026-05-25-channel-group-channel-association.md` on 2026-06-24.
...
**Files:**
- Modify: `services/sdkwork-cloudrouter-router-service/tests/admin_channel_group_api.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/ports/admin_channel_group_store.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/api/admin_channel_group.rs`

- [ ] Write failing API tests for listing and replacing group channel bindings.
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test admin_channel_group_api admin_channel_group_route_lists_and_replaces_channel_bindings`.
...
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/postgres/admin_channel_group_store.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/sqlite/admin_channel_group_store.rs`
- Modify: `crates/sdkwork-cloudrouter-test-support/src/lib.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/sqlite_admin_channel_group_store.rs`
...
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/rows.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/provider_route_selector.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/provider_route_selector.rs`
...
- Generated: `generated/openapi/cloudrouter-backend-openapi.json`
- Generated: `sdks/cloudrouter-backend-sdk/cloudrouter-backend-sdk-typescript/**`
...
**Files:**
- Modify: `apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-group/src/groupService.ts`
- Modify: `apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-admin-group/src/index.tsx`
- Modify/add i18n resources under `apps/sdkwork-cloudrouter-pc/packages/sdkwork-cloudrouter-pc-i18n/src/resources/admin/`
- Test: `apps/sdkwork-cloudrouter-pc/admin-app-runtime.test.ts` or focused admin group runtime test
...
- [ ] Re-run portal runtime test and `pnpm.cmd --dir apps/sdkwork-cloudrouter-pc typecheck`.
