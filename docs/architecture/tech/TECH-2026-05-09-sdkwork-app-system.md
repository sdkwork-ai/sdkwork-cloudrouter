...
Add a test that asserts `data/app/sdkwork-apps.json` exists, has `kind=sdkwork.appstore_app.seed`, contains at least `sdkwork-cloudrouter`, stores `platform_app` fields matching Java `platform_app`, and has no duplicate `appKey`.
...
Run: `cargo test -p sdkwork-cloudrouter-router-service sqlite_installer_installs_schema_and_sdkwork_models_catalog_once -- --nocapture`
...
**Files:**
- Test: `services/sdkwork-cloudrouter-router-service/tests/sqlite_app_store_read_store.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/app_catalog_mapping.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/sqlite/app_store_read_store.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/postgres/app_store_read_store.rs`
...
Run: `cargo test -p sdkwork-cloudrouter-router-service sqlite_app_store_loads_active_apps_for_subject_with_public_contract_fields -- --nocapture`
...
Run: `cargo test -p sdkwork-cloudrouter-router-service sqlite_app_store_read_store -- --nocapture`
...
- Generated: `generated/openapi/cloudrouter-app-openapi.json`
- Generated: `generated/openapi/cloudrouter-backend-openapi.json`
- Generated: `sdks/cloudrouter-app-sdk`
- Generated: `sdks/cloudrouter-backend-sdk`
...
Run: `python -B -m tools.cloudrouter_sdk_guardian` and `python -B -m tools.schema_quality_gate`.
...
Run: `cargo test -p sdkwork-cloudrouter-router-service app_store -- --nocapture`

- [ ] **Step 3: Run installer smoke**

Run: `cargo test -p sdkwork-cloudrouter-router-service database_installer -- --nocapture`
