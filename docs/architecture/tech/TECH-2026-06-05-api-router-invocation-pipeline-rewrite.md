...
**Tech Stack:** Rust, axum, sqlx, existing `sdkwork-cloudrouter-router-service` domain/application ports, existing gateway transport utilities, existing provider adapter registry/client.
...
**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/invocation.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/body.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/subject.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/resource.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/billing.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/routing.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/account.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/dispatch.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/usage.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/telemetry.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/error.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_domain.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_domain`.
- [ ] Commit with `feat: add invocation domain model`.

### Task 2: Add Pipeline and Interceptor Contract

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/interceptor.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/pipeline.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_pipeline.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_pipeline`.
- [ ] Commit with `feat: add invocation pipeline`.

### Task 3: Add Resource Classification

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/classification.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/openai_classifier.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/provider_native_classifier.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Replace: `crates/sdkwork-cloudrouter-edge-runtime/src/openai_route_taxonomy.rs` usage with product-layer classifier
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_classification.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_classification`.
- [ ] Commit with `feat: classify invocation resources`.

### Task 4: Add Request Payload Extraction

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/payload.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_payload.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_payload`.
- [ ] Commit with `feat: extract invocation payload metadata`.

### Task 5: Add Billing Policy and Usage Quantity Planning

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/billing_policy.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/billing.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_billing_policy.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_billing_policy`.
- [ ] Commit with `feat: add invocation billing policy`.

### Task 6: Add Sticky Route Store Port and Interceptors

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/sticky.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/ports/sticky_route_store.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/ports/mod.rs`
- Move logic from: `crates/sdkwork-cloudrouter-edge-runtime/src/route_scoped_openai_passthrough.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_sticky.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_sticky`.
- [ ] Commit with `feat: add sticky invocation routing`.

### Task 7: Add Route Planning and Account Resolution

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/route_planning.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/account_resolution.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_route_planning.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_route_planning`.
- [ ] Commit with `feat: plan invocation routes`.

### Task 8: Add Pricing and Settlement Interceptors

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/pricing.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/settlement.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_pricing_settlement.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_pricing_settlement`.
- [ ] Commit with `feat: settle invocation usage`.

### Task 9: Add Usage Extraction

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/usage_extraction.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/application/invocation/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_usage_extraction.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_usage_extraction`.
- [ ] Commit with `feat: extract invocation usage`.

### Task 10: Add Dispatch Abstraction

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/dispatch_executor.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/ports/invocation_dispatcher.rs`
- Modify: `services/sdkwork-cloudrouter-router-service/src/ports/mod.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_dispatch.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_dispatch`.
- [ ] Commit with `feat: dispatch invocations`.

### Task 11: Add Secret and Request Transform Interceptors

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/secrets.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/request_transform.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_request_transform.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_request_transform`.
- [ ] Commit with `feat: transform invocation requests`.

### Task 12: Add Telemetry and Response Normalization

**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/response_normalization.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/application/invocation/trace.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/invocation_trace_response.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service --test invocation_trace_response`.
- [ ] Commit with `feat: trace invocation outcomes`.

### Task 13: Add Gateway HTTP Adapter

**Files:**
- Create: `crates/sdkwork-cloudrouter-edge-runtime/src/invocation_http.rs`
- Create: `crates/sdkwork-cloudrouter-edge-runtime/src/invocation_router.rs`
- Modify: `crates/sdkwork-cloudrouter-edge-runtime/src/lib.rs`
- Modify: `crates/sdkwork-cloudrouter-edge-runtime/src/runtime.rs`
- Test: `crates/sdkwork-cloudrouter-edge-runtime/tests/invocation_router.rs`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-edge-runtime --test invocation_router`.
- [ ] Commit with `feat: route HTTP through invocation pipeline`.

### Task 14: Delete Old Router Orchestration

**Files:**
- Delete or replace: `services/sdkwork-cloudrouter-router-service/src/api/openai_chat.rs`
- Delete or replace: `services/sdkwork-cloudrouter-router-service/src/api/openai_embeddings.rs`
- Delete or replace: `services/sdkwork-cloudrouter-router-service/src/api/openai_responses.rs`
- Delete or replace: `services/sdkwork-cloudrouter-router-service/src/api/openai_invocation.rs`
- Delete or replace: `services/sdkwork-cloudrouter-router-service/src/api/openai_runtime.rs`
- Delete or replace: `services/sdkwork-cloudrouter-router-service/src/api/openai_usage.rs`
- Delete or replace: `crates/sdkwork-cloudrouter-edge-runtime/src/passthrough.rs`
- Delete or replace: `crates/sdkwork-cloudrouter-edge-runtime/src/route_scoped_openai_passthrough.rs`
...
**Files:**
- Create: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/sqlite/sticky_route_store.rs`
- Create: `services/sdkwork-cloudrouter-router-service/src/infrastructure/sql/postgres/sticky_route_store.rs`
...
- Test: `services/sdkwork-cloudrouter-router-service/tests/sqlite_sticky_route_store.rs`
- Test: `services/sdkwork-cloudrouter-router-service/tests/postgres_sticky_route_store_sql_contract.rs`
...
**Files:**
- Modify/add gateway tests under `crates/sdkwork-cloudrouter-edge-runtime/tests/`
- Modify/add product tests under `services/sdkwork-cloudrouter-router-service/tests/`
...
- [ ] Run `cargo test -p sdkwork-cloudrouter-router-service`.
- [ ] Run `cargo test -p sdkwork-cloudrouter-edge-runtime`.
