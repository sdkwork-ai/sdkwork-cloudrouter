> Migrated from `docs/31-cloudrouter-openapi-generator.md` on 2026-06-24.
> Owner: SDKWork maintainers

`tools.cloudrouter_openapi_generator` generates the published app and backend
...
`tools.cloudrouter_openapi_precision_audit` validates the published app/backend
...
- `generated/openapi/schema-components.yaml`
- `generated/openapi/cloudrouter-app-openapi.json` and
  `generated/openapi/cloudrouter-backend-openapi.json`
