...
This standard describes required module behavior, not verified production
state. The active
[production-readiness revalidation](../../engineering/reviews/REVIEW-20260714-production-readiness-revalidation.md)
records current blockers, including incomplete chat schema installation,
incomplete readiness coverage, unverified streaming/egress controls, and
missing PostgreSQL integration evidence. No text in this document may be used
as proof of high availability, commercial availability, or persistence parity.
