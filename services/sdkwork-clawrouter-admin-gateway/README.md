...
This README is the SDKWork module entrypoint for `sdkwork-clawrouter-admin-gateway`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-clawrouter/services/sdkwork-clawrouter-admin-gateway/Cargo.toml`
