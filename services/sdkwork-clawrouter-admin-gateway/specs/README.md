...
This directory is the local standards index for `sdkwork-clawrouter-admin-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-admin-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/services/sdkwork-clawrouter-admin-gateway` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
