...
This directory is the local standards index for `sdkwork-clawrouter-standalone-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-clawrouter-standalone-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-clawrouter/services/sdkwork-clawrouter-standalone-gateway` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
