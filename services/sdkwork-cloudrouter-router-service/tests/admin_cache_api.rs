...
async fn admin_cache_route_returns_overview_and_supports_refresh_and_delete() {
    ...
    let router =
        sdkwork_cloudrouter_router_service::api::admin_cache_router_with_manager(manager.clone());
...
async fn admin_cache_key_route_accepts_cursor_for_next_page() {
    ...
    let router = sdkwork_cloudrouter_router_service::api::admin_cache_router_with_manager(manager);
...
async fn admin_cache_route_rejects_missing_trusted_subject() {
    let router = sdkwork_cloudrouter_router_service::api::admin_cache_router_with_manager(
        sdkwork_cloudrouter_router_service::application::default_desktop_cache_manager(),
    );
