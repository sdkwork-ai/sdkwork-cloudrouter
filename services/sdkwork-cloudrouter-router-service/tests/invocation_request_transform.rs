...
use sdkwork_cloudrouter_router_service::ports::ProviderSecretResolver;
use serde_json::json;
...
async fn builds_adapter_request_as_standard_json_body() {
    ...
    invocation.dispatch.mode =
        sdkwork_cloudrouter_router_service::application::DispatchMode::InternalProviderAdapter;
