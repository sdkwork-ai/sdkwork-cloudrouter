...
async fn default_cache_runtime_declares_ai_routing_namespaces_for_multilevel_cache() {
    let desktop = sdkwork_cloudrouter_router_service::application::default_desktop_cache_runtime();
    let service = sdkwork_cloudrouter_router_service::application::default_service_cache_runtime(
