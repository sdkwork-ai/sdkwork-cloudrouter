...
use sdkwork_cloudrouter_router_service::application::{ApiKeySecretGenerator, ApiKeySecretHasher};
...
async fn admin_user_route_lists_users_and_api_keys_by_user() {
    ...
    let router = sdkwork_cloudrouter_router_service::api::admin_user_router_with_store(
        store,
        Arc::new(TestHasher),
...
impl sdkwork_cloudrouter_router_service::application::EntityUuidGenerator for TestSecretGenerator {
