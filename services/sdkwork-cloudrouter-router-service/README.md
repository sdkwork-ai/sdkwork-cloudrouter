...
This README is the SDKWork module entrypoint for `sdkwork-cloudrouter-router-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/services/sdkwork-cloudrouter-router-service/Cargo.toml`
