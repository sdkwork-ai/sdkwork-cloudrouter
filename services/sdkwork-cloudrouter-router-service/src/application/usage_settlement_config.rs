...
pub fn usage_settlement_worker_config_from_env_or_toml(
    ...
    const ENABLED: &str = "SDKWORK_CLOUDROUTER_USAGE_SETTLEMENT_WORKER_ENABLED";
    const TENANT_ID: &str = "SDKWORK_CLOUDROUTER_USAGE_SETTLEMENT_TENANT_ID";
    const ORGANIZATION_ID: &str = "SDKWORK_CLOUDROUTER_USAGE_SETTLEMENT_ORGANIZATION_ID";
    const BATCH_SIZE: &str = "SDKWORK_CLOUDROUTER_USAGE_SETTLEMENT_BATCH_SIZE";
    const INTERVAL_MILLIS: &str = "SDKWORK_CLOUDROUTER_USAGE_SETTLEMENT_INTERVAL_MILLIS";
...
mod tests {
    ...
    fn usage_settlement_batch_size_rejects_values_above_the_hard_limit() {
        let error = parse_batch_size_config(
            "SDKWORK_CLOUDROUTER_USAGE_SETTLEMENT_BATCH_SIZE",
