...
impl GatewayAccountingRetryHealth {
    ...
    pub fn readiness_check(&self) -> sdkwork_cloudrouter_http::ReadinessCheckFn {
    ...
    METRIC
        .get_or_init(|| {
            let metric = IntGauge::new(
                "cloudrouter_gateway_accounting_retry_readiness_degraded",
...
fn accounting_retry_dlq_depth_gauge() -> IntGauge {
    ...
    METRIC
        .get_or_init(|| {
            let metric = IntGauge::new(
                "cloudrouter_gateway_accounting_retry_dead_letter_depth",
...
mod tests {
    ...
    use crate::ports::{
        GatewayAccountingRetryQueueFuture, GatewayOfficialRateReference, GatewayUsageRecordCommand,
    };
    ...
    fn usage_command(request_id: &str) -> GatewayUsageRecordCommand {
        GatewayUsageRecordCommand {
            ...
            official_rate: Some(GatewayOfficialRateReference {
                record_identity: Some(crate::ports::GatewayRatingRecordIdentity {
                    price_book_tenant_id: 0,
                    price_book_organization_id: 0,
                    price_book_id: 101,
                    rate_id: 102,
                    account_rate_card_tenant_id: 100,
                    account_rate_card_organization_id: 200,
                    account_rate_card_id: 103,
                    pricing_plan_tenant_id: 100,
                    pricing_plan_organization_id: 200,
                    pricing_plan_id: 104,
                    pricing_rule_tenant_id: 100,
                    pricing_rule_organization_id: 200,
                    pricing_rule_id: 105,
                }),
