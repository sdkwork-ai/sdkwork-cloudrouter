use sdkwork_cloudrouter_config::{DeploymentMode, RuntimeTomlConfig, StartupInstallMode};
...
mod tests {
    ...
    fn runtime_context_reads_only_the_application_scoped_environment_key() {
        unsafe {
            std::env::set_var("SDKWORK_CLOUDROUTER_ROUTER_ENVIRONMENT", "staging");
            std::env::set_var("SDKWORK_CLOUDROUTER_ENVIRONMENT", "development");
        }
