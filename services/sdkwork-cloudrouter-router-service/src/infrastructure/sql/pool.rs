...
use super::runtime_id::{cloud_runtime_id_is_healthy, to_standard_database_config};
...
pub fn redis_readiness_check(redis_url: String) -> sdkwork_cloudrouter_http::ReadinessCheckFn {
    std::sync::Arc::new(move || {
...
pub fn runtime_id_lease_readiness_check() -> sdkwork_cloudrouter_http::ReadinessCheckFn {
    std::sync::Arc::new(|| Box::pin(async { cloud_runtime_id_is_healthy() }))
}
