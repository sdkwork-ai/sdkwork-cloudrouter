...
VALUES
    ($1, $2, $3, $4, 1, $4, 1, 1, $5::timestamp AT TIME ZONE 'UTC', $5::timestamp AT TIME ZONE 'UTC', 0, '{}'::jsonb, $6, $7, $8::jsonb, $9)
...
VALUES
    ($1, $2, $3, $4, 1, $4, 1, 1, $5::timestamp AT TIME ZONE 'UTC', $5::timestamp AT TIME ZONE 'UTC', 0, $6::jsonb, $7, 'Console Settings Webhook', $8, $9::jsonb, 'hmac-sha256', $10::jsonb, 0, $11)
...
async fn upsert_user_preference(
    ...
    sqlx::query(UPSERT_USER_PREFERENCE)
        ...
        .bind(next_cloud_runtime_id("iam_user_preference")?)
        .execute(&mut **tx)
        .await
...
async fn upsert_webhook_endpoint(
    ...
    sqlx::query(UPSERT_WEBHOOK_ENDPOINT)
        ...
        .bind(next_cloud_runtime_id("integration_webhook_endpoint")?)
        .execute(&mut **tx)
        .await
