...
use sdkwork_cloudrouter_http::TenantIsolationViolation;
...
/// Tenant/user scope for Cloud SQL stores that persist BIGINT subject columns.
...
impl SqlScopedSubject {
    ...
    pub fn ensure_row_tenant(
        ...
        sdkwork_cloudrouter_http::ensure_row_tenant_matches(
            table,
            "app-sql",
            self.tenant_id,
            row_tenant_id,
