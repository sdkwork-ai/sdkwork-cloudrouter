...
async fn seed_routing_projection(pool: &PgPool) {
    for statement in [
        ...
        "INSERT INTO ai_upstream_account_credential (id, tenant_id, organization_id, account_id, credential_ref, credential_hash, status, is_active, expires_at) VALUES (201, 100001, 0, 101, 'encrypted-primary-secret', 'hash-primary', 1, true, CURRENT_TIMESTAMP + INTERVAL '1 day'), (202, 100001, 0, 102, 'encrypted-expired-secret', 'hash-expired', 1, true, CURRENT_TIMESTAMP - INTERVAL '1 day'), (203, 100001, 0, 103, 'encrypted-fallback-secret', 'hash-fallback', 1, true, CURRENT_TIMESTAMP + INTERVAL '1 day')",
