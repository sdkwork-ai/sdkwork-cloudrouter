...
use sdkwork_commerce_promotion_repository_sqlx::SqliteCommerceExchangeStore;
use sdkwork_commerce_promotion_service::{AppCommerceExchangeRuleQuery, AppCommerceSubject};
