    ...
    if account_ids.is_empty() {
        ...
        sqlx::query(
            ...
            WHERE tenant_id = $4
              ...
              AND account_group_id = $6
              AND deleted_at IS NULL
              AND NOT (account_id = ANY($7::bigint[]))
            "#,
        )
        .bind(&command.requested_at)
        .bind(command.subject.operator_id)
...
async fn insert_config_snapshot(
    ...
    sqlx::query(
        ...
        VALUES
            ($1, $2, $3, $4, $5, 1, $6, $7, $8, 'ai_upstream_account_group', $9::jsonb, $10::jsonb, $11, $12::timestamptz, $13, $14)
        "#,
    )
    .bind(snapshot_uuid)
    .bind(tenant_id)
