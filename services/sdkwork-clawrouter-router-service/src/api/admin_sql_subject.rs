...
impl_admin_port_subject_from_sql_scope!(crate::ports::AdminSiteSubject);
impl_admin_port_subject_from_sql_scope!(crate::ports::AdminServiceNodeSubject);
impl_admin_port_subject_from_sql_scope!(crate::ports::AdminServiceProviderSubject);
impl_admin_port_subject_from_sql_scope!(crate::ports::AdminProviderSecretSubject);
impl_admin_port_subject_from_sql_scope!(crate::ports::AdminMessagingSubject);
