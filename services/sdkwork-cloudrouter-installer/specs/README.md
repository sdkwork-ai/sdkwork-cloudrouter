# SDKWork Cloud Installer Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-installer`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-installer` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/services/sdkwork-cloudrouter-installer` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/services/sdkwork-cloudrouter-installer/Cargo.toml`
