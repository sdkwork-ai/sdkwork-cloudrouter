//! Thin standalone gateway for the Cloud Router app-api plane (distributed
//! profile).
//!
...
pub use sdkwork_routes_cloudrouter_app_api;

pub const SERVICE_NAME: &str = "sdkwork-cloudrouter-standalone-gateway";

/// Database-free application-plane router (health checks, smoke tests).
pub fn router() -> axum::Router {
    sdkwork_api_cloudrouter_assembly::lightweight_app_router()
}

/// Serve the app-api plane through the canonical API assembly on the
