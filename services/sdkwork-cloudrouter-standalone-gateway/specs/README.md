# SDKWork Cloud App API Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-standalone-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-standalone-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/services/sdkwork-cloudrouter-standalone-gateway` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/services/sdkwork-cloudrouter-standalone-gateway/Cargo.toml`
