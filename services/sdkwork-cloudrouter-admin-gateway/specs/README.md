# SDKWork Cloud Admin API Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-admin-gateway`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-admin-gateway` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/services/sdkwork-cloudrouter-admin-gateway` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/services/sdkwork-cloudrouter-admin-gateway/Cargo.toml`
