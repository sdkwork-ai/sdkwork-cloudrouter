...
use axum::Router;
use sdkwork_cloudrouter_provider_adapter::ProviderAdapter;

pub const ENV_PROVIDER_ADAPTER_BIND: &str = "SDKWORK_CLOUDROUTER_PROVIDER_ADAPTER_BIND";
pub const DEFAULT_PROVIDER_ADAPTER_BIND: &str = "0.0.0.0:39110";
pub const ENV_PROVIDER_ADAPTER_GATEWAY_TOKEN: &str = "SDKWORK_CLOUDROUTER_PROVIDER_ADAPTER_GATEWAY_TOKEN";
pub const ENV_PROVIDER_ADAPTER_GATEWAY_TOKEN_FILE: &str =
    "SDKWORK_CLOUDROUTER_PROVIDER_ADAPTER_GATEWAY_TOKEN_FILE";

pub fn router_with_adapters(
    adapters: Vec<Arc<dyn ProviderAdapter>>,
    gateway_token: impl Into<String>,
) -> Router {
    sdkwork_cloudrouter_provider_adapter_http::adapter_router(adapters, gateway_token)
}
