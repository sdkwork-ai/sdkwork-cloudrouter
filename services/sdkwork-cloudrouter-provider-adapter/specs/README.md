# SDKWork Cloud Provider Adapter Component Specs

This directory is the local standards index for `sdkwork-cloudrouter-provider-adapter`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-cloudrouter-provider-adapter` |
| Type | `rust-crate` |
| Root | `sdkwork-cloudrouter/services/sdkwork-cloudrouter-provider-adapter` |
| Domain | `platform` |
| Capability | `router` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdkwork-cloudrouter/services/sdkwork-cloudrouter-provider-adapter/Cargo.toml`
