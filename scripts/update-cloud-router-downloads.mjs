...
function printHelp() {
  console.log(`Usage: node scripts/update-cloud-router-downloads.mjs [options]
...
function createCloudRouterDownloadCatalog({
  cdnBaseUrl = null,
  generatedAt = null,
  releaseBaseUrl = null,
  releaseTag = null,
