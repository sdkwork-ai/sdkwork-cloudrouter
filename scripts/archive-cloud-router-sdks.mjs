...
function defaultSdkArchiveRoot(root = workspaceRoot) {
  return path.join(root, 'apps', 'sdkwork-cloudrouter-pc', 'dist', 'sdk-archives');
}

function defaultSdkArchiveSpecs(root = workspaceRoot) {
  return [
    sdkArchiveSpecFromDirectory(
      path.join(root, 'sdks', 'cloudrouter-app-sdk', 'cloudrouter-app-sdk-typescript'),
      root,
    ),
    sdkArchiveSpecFromDirectory(
      path.join(root, 'sdks', 'cloudrouter-backend-sdk', 'cloudrouter-backend-sdk-typescript'),
      root,
    ),
    sdkArchiveSpecFromDirectory(
      path.join(root, 'sdks', 'cloudrouter-open-sdk', 'cloudrouter-open-sdk-typescript'),
      root,
    ),
  ];
}
...
function printHelp() {
  console.log(`Usage: node scripts/archive-cloud-router-sdks.mjs [options]
