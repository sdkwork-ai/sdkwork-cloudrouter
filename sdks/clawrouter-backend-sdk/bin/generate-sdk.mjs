...
const domainTransportName = 'clawrouter-backend-domain-transport';
const domainTransportInputPath = `sdks/${sdkFamily}/openapi/${domainTransportName}.openapi.json`;
const domainTransportPackageName = 'sdkwork-clawrouter-backend-sdk-domains-generated-typescript';
