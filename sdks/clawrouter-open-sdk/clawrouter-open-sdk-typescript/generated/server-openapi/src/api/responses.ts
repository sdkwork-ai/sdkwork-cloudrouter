...
export interface ResponsesInputItemsListParams {
  limit?: number;
  order?: 'asc' | 'desc';
  after?: string;
  before?: string;
...
export class ResponsesInputItemsApi {
...
export class ResponsesInputTokensApi {
  private client: HttpClient;
...
export interface ResponsesRetrieveParams {
  include?: string[];
}

export class ResponsesApi {
  private client: HttpClient;
  public readonly inputTokens: ResponsesInputTokensApi;
  public readonly inputItems: ResponsesInputItemsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.inputTokens = new ResponsesInputTokensApi(client);
    this.inputItems = new ResponsesInputItemsApi(client);
  }
