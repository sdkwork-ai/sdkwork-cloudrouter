...
use crate::models::{
    AnthropicDeleteResponse, AnthropicFile, AnthropicFileListResponse,
    AnthropicFileUploadMultipartRequest,
};

#[derive(Clone)]
pub struct FilesAnthropicApi {
    client: Arc<SdkworkHttpClient>,
}

impl FilesAnthropicApi {
    pub fn new(client: Arc<SdkworkHttpClient>) -> Self {
        Self { client }
    }

    /// Anthropic list files
    pub async fn list_v1_files(
        &self,
        before_id: Option<&str>,
        after_id: Option<&str>,
        limit: Option<i64>,
    ) -> Result<AnthropicFileListResponse, SdkworkError> {
    ...
    pub async fn create_v1_file(
        &self,
        body: &AnthropicFileUploadMultipartRequest,
    ) -> Result<AnthropicFile, SdkworkError> {
    ...
    pub async fn delete_v1_files(
        &self,
        file_id: &str,
    ) -> Result<AnthropicDeleteResponse, SdkworkError> {
    ...
    pub async fn list_v1_files_content(&self, file_id: &str) -> Result<String, SdkworkError> {
        let path = ai_path(&format!(
