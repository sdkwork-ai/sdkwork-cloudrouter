...
use crate::models::{AnthropicDeleteResponse, AnthropicFile, AnthropicFileListResponse, AnthropicFileUploadMultipartRequest};
...
impl FilesAnthropicApi {
    ...
    pub async fn list_v1_files(&self, before_id: Option<&str>, after_id: Option<&str>, limit: Option<i64>) -> Result<AnthropicFileListResponse, SdkworkError> {
