...
use crate::models::{
    DeleteResult, OpenAiVideo, OpenAiVideoCharacter, OpenAiVideoCharacterCreateRequest,
    OpenAiVideoCreateRequest, OpenAiVideoEditRequest, OpenAiVideoExtendRequest, OpenAiVideoList,
...
impl VideoApi {
    ...
    pub async fn list(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiVideoList, SdkworkError> {
    ...
    pub async fn create_character(
        &self,
        body: &OpenAiVideoCharacterCreateRequest,
    ) -> Result<OpenAiVideoCharacter, SdkworkError> {
    ...
    pub async fn list_characters(
        ...
        let path = ai_path(&format!(
            ...
            serialize_path_parameter(
                character_id,
                PathParameterSpec::new("character_id", "simple", false)
            )
        ));
        self.client.get(&path, None, None).await
    }
    ...
    pub async fn delete(&self, video_id: &str) -> Result<DeleteResult, SdkworkError> {
        let path = ai_path(&format!(
            ...
            serialize_path_parameter(
                video_id,
                PathParameterSpec::new("video_id", "simple", false)
            )
        ));
