...
use crate::models::{
    DeleteResult, OpenAiContainer, OpenAiContainerCreateRequest, OpenAiContainerFile,
    OpenAiContainerFileCreateMultipartRequest, OpenAiContainerFileList, OpenAiContainerList,
};
...
impl ContainerApi {
    ...
    pub async fn list(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiContainerList, SdkworkError> {
    ...
    pub async fn create(
        &self,
        body: &OpenAiContainerCreateRequest,
    ) -> Result<OpenAiContainer, SdkworkError> {
    ...
    pub async fn delete(&self, container_id: &str) -> Result<DeleteResult, SdkworkError> {
        let path = ai_path(&format!(
            ...
            serialize_path_parameter(
                container_id,
                PathParameterSpec::new("container_id", "simple", false)
            )
        ));
    ...
    pub async fn list_files(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiContainerFileList, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("limit", limit, "form", true, false, None),
            QueryParameterSpec::new("order", order, "form", true, false, None),
            QueryParameterSpec::new("after", after, "form", true, false, None),
    ...
    pub async fn create_file(
        &self,
        container_id: &str,
        body: &OpenAiContainerFileCreateMultipartRequest,
    ) -> Result<OpenAiContainerFile, SdkworkError> {
        let path = ai_path(&format!(
            "/containers/{}/files",
            serialize_path_parameter(
                container_id,
    ...
    pub async fn list_files_content(
        &self,
        container_id: &str,
        file_id: &str,
