...
use crate::models::{AnthropicMessageBatch, AnthropicMessageBatchCreateRequest, AnthropicMessageBatchListResponse};
...
impl BatchesAnthropicApi {
    ...
    pub async fn list_v1_messages_batches(&self, before_id: Option<&str>, after_id: Option<&str>, limit: Option<i64>) -> Result<AnthropicMessageBatchListResponse, SdkworkError> {
