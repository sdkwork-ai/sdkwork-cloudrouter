...
use crate::models::{
    AnthropicMessageBatch, AnthropicMessageBatchCreateRequest, AnthropicMessageBatchListResponse,
};

#[derive(Clone)]
pub struct BatchesAnthropicApi {
    client: Arc<SdkworkHttpClient>,
}

impl BatchesAnthropicApi {
    pub fn new(client: Arc<SdkworkHttpClient>) -> Self {
        Self { client }
    }

    /// Anthropic list message batches
    pub async fn list_v1_messages_batches(
        &self,
        before_id: Option<&str>,
        after_id: Option<&str>,
        limit: Option<i64>,
    ) -> Result<AnthropicMessageBatchListResponse, SdkworkError> {
        ...
        let path = append_query_string(
            ai_path(&"/anthropic/v1/messages/batches".to_string()),
            &query,
        );
    ...
    pub async fn create_v1_messages_batch(
        &self,
        body: &AnthropicMessageBatchCreateRequest,
    ) -> Result<AnthropicMessageBatch, SdkworkError> {
    ...
    pub async fn create_v1_messages_batches_cancel(
        &self,
        batch_id: &str,
    ) -> Result<AnthropicMessageBatch, SdkworkError> {
