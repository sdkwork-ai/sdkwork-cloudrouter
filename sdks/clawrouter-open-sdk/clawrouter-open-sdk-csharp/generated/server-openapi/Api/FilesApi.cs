...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class FilesApi
    {
        ...
        /// List files
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiFileList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiFileList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/files"), queryString));
        }

        /// <summary>
        /// Upload file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiFile?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiFileUploadRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiFile>(ApiPaths.AiPath("/files"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Delete file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string fileId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiFile?> RetrieveAsync(string fileId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiFile>(ApiPaths.AiPath($"/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }
