...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ProjectApi
    {
        ...
        public ProjectApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignmentList?> ListGroupsRolesAsync(string projectId, string groupId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignmentList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/groups/{SerializePathParameter(groupId, new PathParameterSpec("group_id", "simple", false))}/roles"), queryString));
        }

        /// <summary>
        /// Create project group role
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignment?> CreateGroupsRoleAsync(string projectId, string groupId, Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignmentCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignment>(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/groups/{SerializePathParameter(groupId, new PathParameterSpec("group_id", "simple", false))}/roles"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete project group role
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteGroupsRolesAsync(string projectId, string groupId, string roleId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/groups/{SerializePathParameter(groupId, new PathParameterSpec("group_id", "simple", false))}/roles/{SerializePathParameter(roleId, new PathParameterSpec("role_id", "simple", false))}"));
        }

        /// <summary>
        /// List project roles
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiRoleList?> ListRolesAsync(string projectId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page_size", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiRoleList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/roles"), queryString));
        }

        /// <summary>
        /// Create project role
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiRole?> CreateRoleAsync(string projectId, Sdkwork.ClawRouter.Open.Models.OpenAiRoleCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiRole>(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/roles"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete project role
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteRolesAsync(string projectId, string roleId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/roles/{SerializePathParameter(roleId, new PathParameterSpec("role_id", "simple", false))}"));
        }

        /// <summary>
        /// List project user roles
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignmentList?> ListUsersRolesAsync(string projectId, string userId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page_size", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignmentList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/users/{SerializePathParameter(userId, new PathParameterSpec("user_id", "simple", false))}/roles"), queryString));
        }

        /// <summary>
        /// Create project user role
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignment?> CreateUsersRoleAsync(string projectId, string userId, Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignmentCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiRoleAssignment>(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/users/{SerializePathParameter(userId, new PathParameterSpec("user_id", "simple", false))}/roles"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete project user role
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteUsersRolesAsync(string projectId, string userId, string roleId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/projects/{SerializePathParameter(projectId, new PathParameterSpec("project_id", "simple", false))}/users/{SerializePathParameter(userId, new PathParameterSpec("user_id", "simple", false))}/roles/{SerializePathParameter(roleId, new PathParameterSpec("role_id", "simple", false))}"));
        }
