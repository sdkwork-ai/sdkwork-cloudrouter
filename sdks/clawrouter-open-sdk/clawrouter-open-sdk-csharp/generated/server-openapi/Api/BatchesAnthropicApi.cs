...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class BatchesAnthropicApi
    {
        ...
        public BatchesAnthropicApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatchListResponse?> ListV1MessagesBatchesAsync(string? beforeId = null, string? afterId = null, int? limit = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatchListResponse>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/anthropic/v1/messages/batches"), queryString));
        }

        /// <summary>
        /// Anthropic create message batch
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatch?> CreateV1MessagesBatchAsync(Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatchCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatch>(ApiPaths.AiPath("/anthropic/v1/messages/batches"), body, null, null, "application/json");
        }

        /// <summary>
        /// Anthropic cancel message batch
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatch?> CreateV1MessagesBatchesCancelAsync(string batchId)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.AnthropicMessageBatch>(ApiPaths.AiPath($"/anthropic/v1/messages/batches/{SerializePathParameter(batchId, new PathParameterSpec("batch_id", "simple", false))}/cancel"), null);
        }
