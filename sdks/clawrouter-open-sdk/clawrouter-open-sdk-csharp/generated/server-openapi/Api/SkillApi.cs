...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class SkillApi
    {
        ...
        public SkillApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// List skills
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiSkillList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiSkillList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/skills"), queryString));
        }

        /// <summary>
        /// Create skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiSkill?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiSkillCreateMultipartRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiSkill>(ApiPaths.AiPath("/skills"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Delete skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string skillId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiSkill?> RetrieveAsync(string skillId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiSkill>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}"));
        }

        /// <summary>
        /// Modify skill
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiSkill?> UpdateAsync(string skillId, Sdkwork.ClawRouter.Open.Models.OpenAiSkillUpdateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiSkill>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}"), body, null, null, "application/json");
        }

        /// <summary>
        /// Retrieve skill content
        /// </summary>
        public async Task<string?> ContentAsync(string skillId)
        {
            return await _client.GetAsync<string>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}/content"));
        }

        /// <summary>
        /// List skill versions
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiSkillVersionList?> ListVersionsAsync(string skillId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page_size", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiSkillVersionList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}/versions"), queryString));
        }

        /// <summary>
        /// Create skill version
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiSkillVersion?> CreateVersionAsync(string skillId, Sdkwork.ClawRouter.Open.Models.OpenAiSkillVersionCreateMultipartRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiSkillVersion>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}/versions"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Delete skill version
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteVersionsAsync(string skillId, string version)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}/versions/{SerializePathParameter(version, new PathParameterSpec("version", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve skill version content
        /// </summary>
        public async Task<string?> ListVersionsContentAsync(string skillId, string version)
        {
            return await _client.GetAsync<string>(ApiPaths.AiPath($"/skills/{SerializePathParameter(skillId, new PathParameterSpec("skill_id", "simple", false))}/versions/{SerializePathParameter(version, new PathParameterSpec("version", "simple", false))}/content"));
        }
