...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ResponsesApi
    {
        ...
        /// Create response
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiResponse?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiResponsesRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiResponse>(ApiPaths.AiPath("/responses"), body, null, null, "application/json");
        }

        /// <summary>
        /// Compact response
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiResponse?> CompactAsync(Sdkwork.ClawRouter.Open.Models.OpenAiResponseCompactRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiResponse>(ApiPaths.AiPath("/responses/compact"), body, null, null, "application/json");
        }

        /// <summary>
        /// Count response input tokens
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiResponseInputTokenCount?> CreateInputTokenAsync(Sdkwork.ClawRouter.Open.Models.OpenAiResponseInputTokenCountRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiResponseInputTokenCount>(ApiPaths.AiPath("/responses/input_tokens"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete response
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string responseId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/responses/{SerializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve response
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiResponse?> RetrieveAsync(string responseId, List<string>? include = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("include[]", include, "form", true, false, null),
            });
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiResponse>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/responses/{SerializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false))}"), queryString));
        }

        /// <summary>
        /// Cancel response
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiResponse?> CancelAsync(string responseId)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiResponse>(ApiPaths.AiPath($"/responses/{SerializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false))}/cancel"), null);
        }

        /// <summary>
        /// List response input items
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiResponseInputItemList?> ListInputItemsAsync(string responseId, int? limit = null, string? order = null, string? after = null, string? before = null, List<string>? include = null)
        {
            var queryString = BuildQueryString(new[]
            {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiResponseInputItemList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/responses/{SerializePathParameter(responseId, new PathParameterSpec("response_id", "simple", false))}/input_items"), queryString));
        }
