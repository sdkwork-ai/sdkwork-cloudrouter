...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class AssistantsApi
    {
        ...
        /// List assistants
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiAssistantList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiAssistantList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/assistants"), queryString));
        }

        /// <summary>
        /// Create assistant
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiAssistant?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiAssistantCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiAssistant>(ApiPaths.AiPath("/assistants"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete assistant
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string assistantId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/assistants/{SerializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve assistant
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiAssistant?> RetrieveAsync(string assistantId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiAssistant>(ApiPaths.AiPath($"/assistants/{SerializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false))}"));
        }

        /// <summary>
        /// Modify assistant
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiAssistant?> UpdateAsync(string assistantId, Sdkwork.ClawRouter.Open.Models.OpenAiAssistantUpdateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiAssistant>(ApiPaths.AiPath($"/assistants/{SerializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false))}"), body, null, null, "application/json");
        }
