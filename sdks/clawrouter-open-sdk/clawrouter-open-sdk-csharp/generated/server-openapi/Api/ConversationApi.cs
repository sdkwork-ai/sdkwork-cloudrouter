...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ConversationApi
    {
        ...
        /// List conversations
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiConversationList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiConversationList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/conversations"), queryString));
        }

        /// <summary>
        /// Create conversation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiConversation?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiConversationCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiConversation>(ApiPaths.AiPath("/conversations"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete conversation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string conversationId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve conversation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiConversation?> RetrieveAsync(string conversationId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiConversation>(ApiPaths.AiPath($"/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false))}"));
        }

        /// <summary>
        /// Modify conversation
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiConversation?> UpdateAsync(string conversationId, Sdkwork.ClawRouter.Open.Models.OpenAiConversationUpdateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiConversation>(ApiPaths.AiPath($"/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false))}"), body, null, null, "application/json");
        }

        /// <summary>
        /// List conversation items
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiConversationItemList?> ListItemsAsync(string conversationId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("limit", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiConversationItemList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false))}/items"), queryString));
        }

        /// <summary>
        /// Create conversation item
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiConversationItem?> CreateItemAsync(string conversationId, Sdkwork.ClawRouter.Open.Models.OpenAiConversationItemCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiConversationItem>(ApiPaths.AiPath($"/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false))}/items"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete conversation item
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteItemsAsync(string conversationId, string itemId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversation_id", "simple", false))}/items/{SerializePathParameter(itemId, new PathParameterSpec("item_id", "simple", false))}"));
        }
