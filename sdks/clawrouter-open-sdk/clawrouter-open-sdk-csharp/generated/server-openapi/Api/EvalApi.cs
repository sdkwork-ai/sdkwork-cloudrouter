...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class EvalApi
    {
        ...
        public EvalApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// List evals
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEvalList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEvalList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/evals"), queryString));
        }

        /// <summary>
        /// Create eval
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEval?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiEvalCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEval>(ApiPaths.AiPath("/evals"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete eval
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string evalId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve eval
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEval?> RetrieveAsync(string evalId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEval>(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}"));
        }

        /// <summary>
        /// Modify eval
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEval?> UpdateAsync(string evalId, Sdkwork.ClawRouter.Open.Models.OpenAiEvalUpdateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEval>(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}"), body, null, null, "application/json");
        }

        /// <summary>
        /// List eval runs
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEvalRunList?> ListRunsAsync(string evalId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page_size", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEvalRunList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}/runs"), queryString));
        }

        /// <summary>
        /// Create eval run
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEvalRun?> CreateRunAsync(string evalId, Sdkwork.ClawRouter.Open.Models.OpenAiEvalRunCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEvalRun>(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}/runs"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete eval run
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteRunsAsync(string evalId, string runId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}/runs/{SerializePathParameter(runId, new PathParameterSpec("run_id", "simple", false))}"));
        }

        /// <summary>
        /// List eval run output items
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiEvalRunOutputItemList?> ListRunsOutputItemsAsync(string evalId, string runId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("page_size", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiEvalRunOutputItemList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/evals/{SerializePathParameter(evalId, new PathParameterSpec("eval_id", "simple", false))}/runs/{SerializePathParameter(runId, new PathParameterSpec("run_id", "simple", false))}/output_items"), queryString));
        }
