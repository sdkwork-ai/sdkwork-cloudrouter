...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class FilesGoogleApi
    {
        ...
        public FilesGoogleApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleFileListResponse?> ListV1betaFilesAsync(int? pageSize = null, string? pageToken = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.GoogleFileListResponse>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/google/v1beta/files"), queryString));
        }

        /// <summary>
        /// Google Gemini upload file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleFile?> CreateV1betaFileAsync(Sdkwork.ClawRouter.Open.Models.GoogleFileUploadMultipartRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.GoogleFile>(ApiPaths.AiPath("/google/v1beta/files"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Google Gemini delete file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.GoogleEmptyResponse?> DeleteV1betaFilesAsync(string fileId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.GoogleEmptyResponse>(ApiPaths.AiPath($"/google/v1beta/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }
