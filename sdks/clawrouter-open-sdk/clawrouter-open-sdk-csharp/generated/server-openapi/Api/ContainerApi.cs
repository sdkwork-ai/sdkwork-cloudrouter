...
namespace Sdkwork.ClawRouter.Open.Api
{
    public class ContainerApi
    {
        ...
        /// List containers
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiContainerList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiContainerList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/containers"), queryString));
        }

        /// <summary>
        /// Create container
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiContainer?> CreateAsync(Sdkwork.ClawRouter.Open.Models.OpenAiContainerCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiContainer>(ApiPaths.AiPath("/containers"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete container
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteAsync(string containerId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve container
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiContainer?> RetrieveAsync(string containerId)
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiContainer>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}"));
        }

        /// <summary>
        /// List container files
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiContainerFileList?> ListFilesAsync(string containerId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("limit", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.ClawRouter.Open.Models.OpenAiContainerFileList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files"), queryString));
        }

        /// <summary>
        /// Create container file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.OpenAiContainerFile?> CreateFileAsync(string containerId, Sdkwork.ClawRouter.Open.Models.OpenAiContainerFileCreateMultipartRequest body)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.Open.Models.OpenAiContainerFile>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Delete container file
        /// </summary>
        public async Task<Sdkwork.ClawRouter.Open.Models.DeleteResult?> DeleteFilesAsync(string containerId, string fileId)
        {
            return await _client.DeleteAsync<Sdkwork.ClawRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }
