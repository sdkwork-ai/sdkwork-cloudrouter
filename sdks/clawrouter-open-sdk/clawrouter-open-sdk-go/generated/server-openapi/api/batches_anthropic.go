...
type BatchesAnthropicApi struct {
    client *sdkhttp.Client
}

func NewBatchesAnthropicApi(client *sdkhttp.Client) *BatchesAnthropicApi {
    return &BatchesAnthropicApi{client: client}
}

// Anthropic list message batches
func (a *BatchesAnthropicApi) ListV1MessagesBatches(beforeId *string, afterId *string, limit *int) (sdktypes.AnthropicMessageBatchListResponse, error) {
    ...
    return decodeResult[sdktypes.AnthropicMessageBatchListResponse](raw)
}
...
func (a *BatchesAnthropicApi) CreateV1MessagesBatch(body sdktypes.AnthropicMessageBatchCreateRequest) (sdktypes.AnthropicMessageBatch, error) {
    ...
    return decodeResult[sdktypes.AnthropicMessageBatch](raw)
}
