...
// List assistants
func (a *AssistantsApi) List(limit *int, order *string, after *string, before *string) (sdktypes.OpenAiAssistantList, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(AiApiPath("/assistants"), query), nil, nil)
    if err != nil {
        var zero sdktypes.OpenAiAssistantList
        return zero, err
    }
    return decodeResult[sdktypes.OpenAiAssistantList](raw)
}

// Create assistant
func (a *AssistantsApi) Create(body sdktypes.OpenAiAssistantCreateRequest) (sdktypes.OpenAiAssistant, error) {
    raw, err := a.client.Post(AiApiPath("/assistants"), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.OpenAiAssistant
        return zero, err
    }
    return decodeResult[sdktypes.OpenAiAssistant](raw)
}

// Delete assistant
func (a *AssistantsApi) Delete(assistantId string) (sdktypes.DeleteResult, error) {
    raw, err := a.client.Delete(AiApiPath(fmt.Sprintf("/assistants/%s", SerializePathParameter(assistantId, PathParameterSpec{Name: "assistant_id", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
...
// Retrieve assistant
func (a *AssistantsApi) Retrieve(assistantId string) (sdktypes.OpenAiAssistant, error) {
    raw, err := a.client.Get(AiApiPath(fmt.Sprintf("/assistants/%s", SerializePathParameter(assistantId, PathParameterSpec{Name: "assistant_id", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero sdktypes.OpenAiAssistant
        return zero, err
    }
...
// Modify assistant
func (a *AssistantsApi) Update(assistantId string, body sdktypes.OpenAiAssistantUpdateRequest) (sdktypes.OpenAiAssistant, error) {
    raw, err := a.client.Post(AiApiPath(fmt.Sprintf("/assistants/%s", SerializePathParameter(assistantId, PathParameterSpec{Name: "assistant_id", Style: "simple", Explode: false}))), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.OpenAiAssistant
        return zero, err
    }
