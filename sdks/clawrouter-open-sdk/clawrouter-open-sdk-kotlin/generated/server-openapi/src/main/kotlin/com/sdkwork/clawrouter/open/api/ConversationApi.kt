...
class ConversationApi(private val client: HttpClient) {
    ...
    suspend fun list(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiConversationList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/conversations"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiConversationList>() {})
    }

    /** Create conversation */
    suspend fun create(body: OpenAiConversationCreateRequest): OpenAiConversation? {
        val raw = client.post(ApiPaths.aiPath("/conversations"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiConversation>() {})
    }

    /** Delete conversation */
    suspend fun delete(conversationId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversation_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve conversation */
    suspend fun retrieve(conversationId: String): OpenAiConversation? {
        val raw = client.get(ApiPaths.aiPath("/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversation_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<OpenAiConversation>() {})
    }

    /** Modify conversation */
    suspend fun update(conversationId: String, body: OpenAiConversationUpdateRequest): OpenAiConversation? {
        val raw = client.post(ApiPaths.aiPath("/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversation_id", "simple", false))}"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiConversation>() {})
    }
    ...
    suspend fun listItems(conversationId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiConversationItemList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversation_id", "simple", false))}/items"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiConversationItemList>() {})
    }

    /** Create conversation item */
    suspend fun createItem(conversationId: String, body: OpenAiConversationItemCreateRequest): OpenAiConversationItem? {
        val raw = client.post(ApiPaths.aiPath("/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversation_id", "simple", false))}/items"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiConversationItem>() {})
    }

    /** Delete conversation item */
    suspend fun deleteItems(conversationId: String, itemId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/conversations/${serializePathParameter(conversationId, PathParameterSpec("conversation_id", "simple", false))}/items/${serializePathParameter(itemId, PathParameterSpec("item_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }
