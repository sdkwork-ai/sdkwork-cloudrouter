...
class ResponsesGoogleApi(private val client: HttpClient) {

    /** Google Gemini list cached contents */
    suspend fun listV1betaCachedContents(pageSize: Int? = null, pageToken: String? = null): GoogleCachedContentListResponse? {
