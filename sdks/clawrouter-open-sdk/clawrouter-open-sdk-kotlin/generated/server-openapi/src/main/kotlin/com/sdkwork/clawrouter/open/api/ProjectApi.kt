...
class ProjectApi(private val client: HttpClient) {
    ...
    suspend fun listGroupsRoles(projectId: String, groupId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiRoleAssignmentList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/groups/${serializePathParameter(groupId, PathParameterSpec("group_id", "simple", false))}/roles"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiRoleAssignmentList>() {})
    }

    /** Create project group role */
    suspend fun createGroupsRole(projectId: String, groupId: String, body: OpenAiRoleAssignmentCreateRequest): OpenAiRoleAssignment? {
        val raw = client.post(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/groups/${serializePathParameter(groupId, PathParameterSpec("group_id", "simple", false))}/roles"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiRoleAssignment>() {})
    }

    /** Delete project group role */
    suspend fun deleteGroupsRoles(projectId: String, groupId: String, roleId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/groups/${serializePathParameter(groupId, PathParameterSpec("group_id", "simple", false))}/roles/${serializePathParameter(roleId, PathParameterSpec("role_id", "simple", false))}"))
    ...
    suspend fun listRoles(projectId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiRoleList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/roles"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiRoleList>() {})
    }

    /** Create project role */
    suspend fun createRole(projectId: String, body: OpenAiRoleCreateRequest): OpenAiRole? {
        val raw = client.post(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/roles"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiRole>() {})
    }

    /** Delete project role */
    suspend fun deleteRoles(projectId: String, roleId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/roles/${serializePathParameter(roleId, PathParameterSpec("role_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }
    ...
    suspend fun listUsersRoles(projectId: String, userId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiRoleAssignmentList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/users/${serializePathParameter(userId, PathParameterSpec("user_id", "simple", false))}/roles"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiRoleAssignmentList>() {})
    }

    /** Create project user role */
    suspend fun createUsersRole(projectId: String, userId: String, body: OpenAiRoleAssignmentCreateRequest): OpenAiRoleAssignment? {
        val raw = client.post(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/users/${serializePathParameter(userId, PathParameterSpec("user_id", "simple", false))}/roles"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiRoleAssignment>() {})
    }

    /** Delete project user role */
    suspend fun deleteUsersRoles(projectId: String, userId: String, roleId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/projects/${serializePathParameter(projectId, PathParameterSpec("project_id", "simple", false))}/users/${serializePathParameter(userId, PathParameterSpec("user_id", "simple", false))}/roles/${serializePathParameter(roleId, PathParameterSpec("role_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }
