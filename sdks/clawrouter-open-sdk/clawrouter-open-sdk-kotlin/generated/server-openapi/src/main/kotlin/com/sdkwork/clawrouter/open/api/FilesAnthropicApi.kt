...
class FilesAnthropicApi(private val client: HttpClient) {

    /** Anthropic list files */
    suspend fun listV1Files(beforeId: String? = null, afterId: String? = null, limit: Int? = null): AnthropicFileListResponse? {
