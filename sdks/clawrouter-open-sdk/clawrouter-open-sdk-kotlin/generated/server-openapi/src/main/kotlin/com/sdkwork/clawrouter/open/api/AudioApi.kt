...
class AudioApi(private val client: HttpClient) {
    ...
    /** Create speech */
    suspend fun createSpeech(body: OpenAiSpeechCreateRequest): String? {
        val raw = client.post(ApiPaths.aiPath("/audio/speech"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<String>() {})
    }

    /** Create transcription */
    suspend fun createTranscription(body: OpenAiAudioTranscriptionRequest): OpenAiAudioTranscription? {
        val raw = client.post(ApiPaths.aiPath("/audio/transcriptions"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiAudioTranscription>() {})
    }

    /** Create translation */
    suspend fun createTranslation(body: OpenAiAudioTranslationRequest): OpenAiAudioTranslation? {
        val raw = client.post(ApiPaths.aiPath("/audio/translations"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiAudioTranslation>() {})
    }
    ...
    suspend fun listVoiceConsents(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiVoiceConsentList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/audio/voice_consents"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiVoiceConsentList>() {})
    }

    /** Create voice consent */
    suspend fun createVoiceConsent(body: OpenAiVoiceConsentCreateRequest): OpenAiVoiceConsent? {
        val raw = client.post(ApiPaths.aiPath("/audio/voice_consents"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVoiceConsent>() {})
    }

    /** Delete voice consent */
    suspend fun deleteVoiceConsents(consentId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/audio/voice_consents/${serializePathParameter(consentId, PathParameterSpec("consent_id", "simple", false))}"))
    ...
    suspend fun listVoices(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiVoiceList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/audio/voices"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiVoiceList>() {})
    }

    /** Create voice */
    suspend fun createVoice(body: OpenAiVoiceCreateRequest): OpenAiVoice? {
        val raw = client.post(ApiPaths.aiPath("/audio/voices"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVoice>() {})
    }
