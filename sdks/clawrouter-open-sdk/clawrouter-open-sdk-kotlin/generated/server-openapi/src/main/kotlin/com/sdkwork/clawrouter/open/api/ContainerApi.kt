...
class ContainerApi(private val client: HttpClient) {
    ...
    suspend fun list(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiContainerList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/containers"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiContainerList>() {})
    }

    /** Create container */
    suspend fun create(body: OpenAiContainerCreateRequest): OpenAiContainer? {
        val raw = client.post(ApiPaths.aiPath("/containers"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiContainer>() {})
    }

    /** Delete container */
    suspend fun delete(containerId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/containers/${serializePathParameter(containerId, PathParameterSpec("container_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve container */
    suspend fun retrieve(containerId: String): OpenAiContainer? {
        val raw = client.get(ApiPaths.aiPath("/containers/${serializePathParameter(containerId, PathParameterSpec("container_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<OpenAiContainer>() {})
    }
    ...
    suspend fun listFiles(containerId: String, limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiContainerFileList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/containers/${serializePathParameter(containerId, PathParameterSpec("container_id", "simple", false))}/files"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiContainerFileList>() {})
    }

    /** Create container file */
    suspend fun createFile(containerId: String, body: OpenAiContainerFileCreateMultipartRequest): OpenAiContainerFile? {
        val raw = client.post(ApiPaths.aiPath("/containers/${serializePathParameter(containerId, PathParameterSpec("container_id", "simple", false))}/files"), body, null, null, "multipart/form-data")
        return client.convertValue(raw, object : TypeReference<OpenAiContainerFile>() {})
    }

    /** Delete container file */
    suspend fun deleteFiles(containerId: String, fileId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/containers/${serializePathParameter(containerId, PathParameterSpec("container_id", "simple", false))}/files/${serializePathParameter(fileId, PathParameterSpec("file_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve container file content */
    suspend fun listFilesContent(containerId: String, fileId: String): String? {
        val raw = client.get(ApiPaths.aiPath("/containers/${serializePathParameter(containerId, PathParameterSpec("container_id", "simple", false))}/files/${serializePathParameter(fileId, PathParameterSpec("file_id", "simple", false))}/content"))
