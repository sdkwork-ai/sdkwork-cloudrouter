...
class VideoApi(private val client: HttpClient) {
    ...
    /** List videos */
    suspend fun list(limit: Int? = null, order: String? = null, after: String? = null, before: String? = null): OpenAiVideoList? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.aiPath("/videos"), query))
        return client.convertValue(raw, object : TypeReference<OpenAiVideoList>() {})
    }

    /** Create video */
    suspend fun create(body: OpenAiVideoCreateRequest): OpenAiVideo? {
        val raw = client.post(ApiPaths.aiPath("/videos"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVideo>() {})
    }

    /** Create video character */
    suspend fun createCharacter(body: OpenAiVideoCharacterCreateRequest): OpenAiVideoCharacter? {
        val raw = client.post(ApiPaths.aiPath("/videos/characters"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVideoCharacter>() {})
    }

    /** Retrieve video character */
    suspend fun listCharacters(characterId: String): OpenAiVideoCharacter? {
        val raw = client.get(ApiPaths.aiPath("/videos/characters/${serializePathParameter(characterId, PathParameterSpec("character_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<OpenAiVideoCharacter>() {})
    }

    /** Edit video */
    suspend fun createEdit(body: OpenAiVideoEditRequest): OpenAiVideo? {
        val raw = client.post(ApiPaths.aiPath("/videos/edits"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVideo>() {})
    }

    /** Extend video */
    suspend fun createExtension(body: OpenAiVideoExtendRequest): OpenAiVideo? {
        val raw = client.post(ApiPaths.aiPath("/videos/extensions"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVideo>() {})
    }

    /** Delete video */
    suspend fun delete(videoId: String): DeleteResult? {
        val raw = client.delete(ApiPaths.aiPath("/videos/${serializePathParameter(videoId, PathParameterSpec("video_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<DeleteResult>() {})
    }

    /** Retrieve video */
    suspend fun retrieve(videoId: String): OpenAiVideo? {
        val raw = client.get(ApiPaths.aiPath("/videos/${serializePathParameter(videoId, PathParameterSpec("video_id", "simple", false))}"))
        return client.convertValue(raw, object : TypeReference<OpenAiVideo>() {})
    }

    /** Retrieve video content */
    suspend fun content(videoId: String): String? {
        val raw = client.get(ApiPaths.aiPath("/videos/${serializePathParameter(videoId, PathParameterSpec("video_id", "simple", false))}/content"))
        return client.convertValue(raw, object : TypeReference<String>() {})
    }

    /** Remix video */
    suspend fun createRemix(videoId: String, body: OpenAiVideoRemixRequest): OpenAiVideo? {
        val raw = client.post(ApiPaths.aiPath("/videos/${serializePathParameter(videoId, PathParameterSpec("video_id", "simple", false))}/remix"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<OpenAiVideo>() {})
    }
