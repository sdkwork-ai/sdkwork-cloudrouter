...
class BatchesAnthropicApi(private val client: HttpClient) {

    /** Anthropic list message batches */
    suspend fun listV1MessagesBatches(beforeId: String? = null, afterId: String? = null, limit: Int? = null): AnthropicMessageBatchListResponse? {
