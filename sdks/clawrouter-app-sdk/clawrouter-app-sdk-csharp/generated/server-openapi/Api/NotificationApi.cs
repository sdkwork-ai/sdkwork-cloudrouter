...
namespace Sdkwork.ClawRouter.App.Api
{
    public class NotificationApi
    {
        ...
        {
            return await _client.GetAsync<Sdkwork.ClawRouter.App.Models.NotificationsListResult>(ApiPaths.AppPath("/notification/notifications"));
        }

        /// <summary>
        /// Create
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.NotificationsAcknowledgeCreateResult?> NotificationsAcknowledgeCreateAsync(string notificationId)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.NotificationsAcknowledgeCreateResult>(ApiPaths.AppPath($"/notification/notifications/{SerializePathParameter(notificationId, new PathParameterSpec("notificationId", "simple", false))}/acknowledge"), null);
        }

        /// <summary>
        /// Create
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.NotificationsPopupSeenCreateResult?> NotificationsPopupSeenCreateAsync(string notificationId)
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.NotificationsPopupSeenCreateResult>(ApiPaths.AppPath($"/notification/notifications/{SerializePathParameter(notificationId, new PathParameterSpec("notificationId", "simple", false))}/popup_seen"), null);
        }
