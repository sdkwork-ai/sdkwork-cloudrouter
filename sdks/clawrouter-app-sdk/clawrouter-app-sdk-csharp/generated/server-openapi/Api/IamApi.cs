...
namespace Sdkwork.ClawRouter.App.Api
{
    public class IamApi
    {
        ...
        /// Create
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.ApiKeysCreateResult?> ApiKeysCreateAsync()
        {
            return await _client.PostAsync<Sdkwork.ClawRouter.App.Models.ApiKeysCreateResult>(ApiPaths.AppPath("/iam/api_keys"), null);
        }
        ...
        /// Update
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.ApiKeysUpdateResult?> ApiKeysUpdateAsync(string apiKeyId)
        {
            return await _client.PatchAsync<Sdkwork.ClawRouter.App.Models.ApiKeysUpdateResult>(ApiPaths.AppPath($"/iam/api_keys/{SerializePathParameter(apiKeyId, new PathParameterSpec("apiKeyId", "simple", false))}"), null);
        }
        ...
        /// Update
        /// </summary>
        public async Task<Sdkwork.ClawRouter.App.Models.UsersSettingsUpdateResult?> UsersSettingsUpdateAsync()
        {
            return await _client.PutAsync<Sdkwork.ClawRouter.App.Models.UsersSettingsUpdateResult>(ApiPaths.AppPath("/iam/users/settings"), null);
        }
