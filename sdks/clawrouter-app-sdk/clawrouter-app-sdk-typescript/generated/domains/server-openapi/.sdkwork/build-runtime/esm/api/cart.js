...
export class CartItemsApi {
    ...
    /** Create */
    async create() {
        return this.client.post(appApiPath(`/cart/items`));
    }
    /** Delete */
    async delete(cartItemId) {
        return this.client.delete(appApiPath(`/cart/items/${serializePathParameter(cartItemId, { name: 'cartItemId', style: 'simple', explode: false })}`));
    }
    /** Update */
    async update(cartItemId) {
        return this.client.patch(appApiPath(`/cart/items/${serializePathParameter(cartItemId, { name: 'cartItemId', style: 'simple', explode: false })}`));
    }
}
export class CartCurrentApi {
    ...
    /** Retrieve */
    async retrieve() {
        return this.client.get(appApiPath(`/cart/current`));
    }
}
