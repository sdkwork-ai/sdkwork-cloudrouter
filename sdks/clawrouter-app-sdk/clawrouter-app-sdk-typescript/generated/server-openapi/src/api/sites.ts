...
export interface SitesRuntimeRetrieveParams {
  tenantCode?: string;
  organizationCode?: string;
}

export class SitesRuntimeApi {
...
/** Retrieve public site runtime branding settings */
  async retrieve(params?: SitesRuntimeRetrieveParams): Promise<SiteRuntimeRetrieveResult> {
...
export class SitesApi {
  private client: HttpClient;
  public readonly runtime: SitesRuntimeApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.runtime = new SitesRuntimeApi(client);
  }
