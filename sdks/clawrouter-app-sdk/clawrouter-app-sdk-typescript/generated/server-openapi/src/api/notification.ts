...
import type { AcknowledgeNotificationResponse, MarkNotificationPopupSeenResponse, NotificationListResponse } from '../types';
...
/** Mark popup seen */
  async create(notificationId: string, params?: NotificationPopupSeenCreateParams, requestOptions?: ApiRequestOptions): Promise<MarkNotificationPopupSeenResponse> {
...
/** Acknowledge */
  async create(notificationId: string, params?: NotificationAcknowledgeCreateParams, requestOptions?: ApiRequestOptions): Promise<AcknowledgeNotificationResponse> {
    const query = buildQueryString([
      { name: 'app_id', value: params?.appId, style: 'form', explode: true, allowReserved: false },
    ]);
...
/** List notifications */
  async list(params?: NotificationListParams, requestOptions?: ApiRequestOptions): Promise<NotificationListResponse> {
    const query = buildQueryString([
      { name: 'app_id', value: params?.appId, style: 'form', explode: true, allowReserved: false },
