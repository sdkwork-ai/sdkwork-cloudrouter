...
export class RefundsApi {
    ...
    /** List */
    async list() {
        return this.client.get(appApiPath(`/refunds`));
    }
    /** Create */
    async create() {
        return this.client.post(appApiPath(`/refunds`));
    }
    /** Retrieve */
    async retrieve(refundId) {
        return this.client.get(appApiPath(`/refunds/${serializePathParameter(refundId, { name: 'refundId', style: 'simple', explode: false })}`));
    }
}
export function createRefundsApi(client) {
