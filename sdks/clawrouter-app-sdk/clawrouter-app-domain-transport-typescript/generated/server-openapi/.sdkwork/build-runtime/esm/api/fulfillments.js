...
export class FulfillmentsApi {
    ...
    /** List */
    async list() {
        return this.client.get(appApiPath(`/fulfillments`));
    }
    /** Retrieve */
    async retrieve(fulfillmentId) {
        return this.client.get(appApiPath(`/fulfillments/${serializePathParameter(fulfillmentId, { name: 'fulfillmentId', style: 'simple', explode: false })}`));
    }
}
export function createFulfillmentsApi(client) {
