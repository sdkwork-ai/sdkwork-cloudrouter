# cloudrouter-app-sdk (Swift)

SDKWork Cloud Router app API SDK swift generated transport SDK
...
```swift
dependencies: [
    .package(url: "https://github.com/sdkwork/CloudRouterAppSdk", from: "0.1.0")
]
```
