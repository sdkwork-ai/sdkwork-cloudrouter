# cloudrouter-app-sdk (Rust)

SDKWork Cloud Router app API SDK rust generated transport SDK

## Installation

```bash
cargo add cloudrouter-app-sdk
```

## Quick Start

```rust
use cloudrouter_app_sdk::{SdkworkAppClient, SdkworkConfig};
