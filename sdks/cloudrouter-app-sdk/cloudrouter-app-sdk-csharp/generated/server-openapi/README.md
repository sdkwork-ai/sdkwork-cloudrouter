# cloudrouter-app-sdk (C#)

SDKWork Cloud Router app API SDK csharp generated transport SDK

## Installation

```bash
dotnet add package Sdkwork.CloudRouter.App.Sdk
```

Or add to your `.csproj`:

```xml
<PackageReference Include="Sdkwork.CloudRouter.App.Sdk" Version="0.1.0" />
```
