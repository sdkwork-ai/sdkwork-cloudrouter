...
namespace Sdkwork.CloudRouter.App.Api
{
    public class NotificationApi
    {
        ...
        /// List
        /// </summary>
        public async Task<Sdkwork.CloudRouter.App.Models.NotificationsListResult?> NotificationsListAsync()
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.App.Models.NotificationsListResult>(ApiPaths.AppPath("/notification/notifications"));
        }

        /// <summary>
        /// Create
        /// </summary>
        public async Task<Sdkwork.CloudRouter.App.Models.NotificationsAcknowledgeCreateResult?> NotificationsAcknowledgeCreateAsync(string notificationId)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.App.Models.NotificationsAcknowledgeCreateResult>(ApiPaths.AppPath($"/notification/notifications/{SerializePathParameter(notificationId, new PathParameterSpec("notificationId", "simple", false))}/acknowledge"), null);
        }

        /// <summary>
        /// Create
        /// </summary>
        public async Task<Sdkwork.CloudRouter.App.Models.NotificationsPopupSeenCreateResult?> NotificationsPopupSeenCreateAsync(string notificationId)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.App.Models.NotificationsPopupSeenCreateResult>(ApiPaths.AppPath($"/notification/notifications/{SerializePathParameter(notificationId, new PathParameterSpec("notificationId", "simple", false))}/popup_seen"), null);
        }
