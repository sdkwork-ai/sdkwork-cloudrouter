# cloudrouter-app-sdk (Go)

SDKWork Cloud Router app API SDK go generated transport SDK

## Installation

```bash
go get github.com/sdkwork/cloudrouter-app-sdk
```
...
import (
    "fmt"
    "github.com/sdkwork/cloudrouter-app-sdk"
...
func main() {
    ...
    client := github.com/sdkwork/cloudrouter-app-sdk.NewSdkworkAppClientWithConfig(cfg)
