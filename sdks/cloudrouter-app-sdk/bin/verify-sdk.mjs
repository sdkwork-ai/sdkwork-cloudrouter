...
const required = [
  'sdk-manifest.json',
  'openapi/cloudrouter-app-sdk.openapi.json',
  'openapi/cloudrouter-app-sdk.sdkgen.json',
  'cloudrouter-app-sdk-typescript/generated/server-openapi/package.json',
  'cloudrouter-app-sdk-typescript/generated/server-openapi/sdkwork-sdk.json',
  'cloudrouter-app-sdk-typescript/generated/server-openapi/src/index.ts',
];
const missing = required.filter((entry) => !existsSync(path.join(workspaceRoot, entry)));
if (missing.length > 0) {
  throw new Error('cloudrouter-app-sdk SDK family is incomplete: ' + missing.join(', '));
}
const assembly = JSON.parse(readFileSync(path.join(workspaceRoot, 'sdk-manifest.json'), 'utf8'));
if (assembly.workspace !== 'cloudrouter-app-sdk') {
  throw new Error('SDK assembly workspace drifted');
}
const expectedGenerationInputSpec = 'openapi/cloudrouter-app-sdk.openapi.json';
...
console.log('Verified cloudrouter-app-sdk SDK family.');
