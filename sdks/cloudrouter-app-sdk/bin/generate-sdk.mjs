...
const description = 'SDKWork Cloud Router app API SDK';
const OFFICIAL_LANGUAGES = ['typescript', 'flutter', 'rust', 'java', 'csharp', 'swift', 'kotlin', 'go', 'python'];
const packageNames = {"csharp": "Sdkwork.CloudRouter.App.Sdk", "flutter": "cloudrouter_app_sdk", "go": "github.com/sdkwork/cloudrouter-app-sdk", "java": "com.sdkwork.cloudrouter:cloudrouter-app-sdk", "kotlin": "com.sdkwork.cloudrouter:cloudrouter-app-sdk", "python": "sdkwork-cloudrouter-app-sdk", "rust": "cloudrouter-app-sdk", "swift": "CloudRouterAppSdk", "typescript": "@sdkwork/cloudrouter-app-sdk"};
const namespaces = {"csharp": "Sdkwork.CloudRouter.App", "java": "com.sdkwork.cloudrouter.app", "kotlin": "com.sdkwork.cloudrouter.app"};
...
function strictTypeScriptArgs() {
  return [
    ...
    '-o', 'sdks/cloudrouter-app-sdk/cloudrouter-app-sdk-typescript/generated/server-openapi',
    '-n', sdkFamily,
    '-t', sdkType,
    '-l', 'typescript',
    '--base-url', baseUrl,
...
function generatedOutputPath(language) {
  if (language === 'typescript') {
    return 'sdks/cloudrouter-app-sdk/cloudrouter-app-sdk-typescript/generated/server-openapi';
  }
