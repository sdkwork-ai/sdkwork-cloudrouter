...
- Authority contract: `openapi/cloudrouter-app-sdk.openapi.json`
- Derived sdkgen contract: `openapi/cloudrouter-app-sdk.sdkgen.json` (synchronized artifact, not a generation source)
- SDK generation input: `openapi/cloudrouter-app-sdk.openapi.json`
- Assembly snapshot: `sdk-manifest.json`
- TypeScript workspace: `cloudrouter-app-sdk-typescript`
- TypeScript generated output: `cloudrouter-app-sdk-typescript/generated/server-openapi`
...
The materialized TypeScript package is `@sdkwork/cloudrouter-app-sdk` and lives under `cloudrouter-app-sdk-typescript/generated/server-openapi`. The `cloudrouter-app-sdk-typescript` directory is the language workspace boundary.
...
```bash
node ./sdks/cloudrouter-app-sdk/bin/generate-sdk.mjs
```

Regenerate selected languages:

```bash
node ./sdks/cloudrouter-app-sdk/bin/generate-sdk.mjs --language typescript --language flutter
```

Verify this SDK family from the project root:

```bash
node ./sdks/cloudrouter-app-sdk/bin/verify-sdk.mjs
```
