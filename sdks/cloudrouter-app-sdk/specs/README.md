# SDKWork Cloud Router app API SDK Component Specs

This directory is the local standards index for `cloudrouter-app-sdk`.
...
| Field | Value |
| --- | --- |
| Name | `cloudrouter-app-sdk` |
| Type | `sdk-family` |
| Root | `sdkwork-cloudrouter/sdks/cloudrouter-app-sdk` |
| Domain | `platform` |
| Capability | `router` |
