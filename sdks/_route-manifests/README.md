...
`sdks/_route-manifests/` stores SDKWork HTTP route manifest inputs for Cloud Router. Each manifest records `requestContext: WebRequestContext`, `apiSurface`, handler ownership, auth mode, and materialized OpenAPI extensions.
...
SDKWork Cloud Router API maintainers.
