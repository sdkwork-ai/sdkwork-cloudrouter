# cloudrouter-backend-sdk (Swift)

SDKWork Cloud Router backend API SDK swift generated transport SDK
...
```swift
dependencies: [
    .package(url: "https://github.com/sdkwork/CloudRouterBackendSdk", from: "0.1.0")
]
```
