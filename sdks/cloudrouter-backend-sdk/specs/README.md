# SDKWork Cloud Router backend API SDK Component Specs

This directory is the local standards index for `cloudrouter-backend-sdk`.
...
| Field | Value |
| --- | --- |
| Name | `cloudrouter-backend-sdk` |
| Type | `sdk-family` |
| Root | `sdkwork-cloudrouter/sdks/cloudrouter-backend-sdk` |
| Domain | `platform` |
| Capability | `router` |
