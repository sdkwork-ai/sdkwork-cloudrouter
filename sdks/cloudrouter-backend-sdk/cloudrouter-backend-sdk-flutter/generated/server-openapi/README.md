# cloudrouter-backend-sdk (Flutter)

SDKWork Cloud Router backend API SDK flutter generated transport SDK
...
```yaml
dependencies:
  cloudrouter_backend_sdk: ^0.1.0
```

## Quick Start

```dart
import 'package:cloudrouter_backend_sdk/cloudrouter_backend_sdk.dart';
