# cloudrouter-backend-sdk (C#)

SDKWork Cloud Router backend API SDK csharp generated transport SDK

## Installation

```bash
dotnet add package Sdkwork.CloudRouter.Backend.Sdk
```

Or add to your `.csproj`:

```xml
<PackageReference Include="Sdkwork.CloudRouter.Backend.Sdk" Version="0.1.0" />
```
...
using Sdkwork.CloudRouter.Backend;
