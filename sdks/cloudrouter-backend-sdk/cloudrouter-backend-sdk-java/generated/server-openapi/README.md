# cloudrouter-backend-sdk (Java)

SDKWork Cloud Router backend API SDK java generated transport SDK
...
```xml
<dependency>
    <groupId>com.sdkwork.cloudrouter</groupId>
    <artifactId>cloudrouter-backend-sdk</artifactId>
...
```groovy
implementation 'com.sdkwork.cloudrouter:cloudrouter-backend-sdk:0.1.0'
```

## Quick Start

```java
import com.sdkwork.cloudrouter.backend.SdkworkBackendClient;
