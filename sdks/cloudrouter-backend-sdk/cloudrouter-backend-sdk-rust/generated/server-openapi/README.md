# cloudrouter-backend-sdk (Rust)

SDKWork Cloud Router backend API SDK rust generated transport SDK

## Installation

```bash
cargo add cloudrouter-backend-sdk
```

## Quick Start

```rust
use cloudrouter_backend_sdk::{SdkworkBackendClient, SdkworkConfig};
