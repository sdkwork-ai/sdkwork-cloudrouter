...
const sdkFamily = 'cloudrouter-backend-sdk';
...
const description = 'SDKWork Cloud Router backend API SDK';
const OFFICIAL_LANGUAGES = ['typescript', 'flutter', 'rust', 'java', 'csharp', 'swift', 'kotlin', 'go', 'python'];
const packageNames = {"csharp": "Sdkwork.CloudRouter.Backend.Sdk", "flutter": "cloudrouter_backend_sdk", "go": "github.com/sdkwork/cloudrouter-backend-sdk", "java": "com.sdkwork.cloudrouter:cloudrouter-backend-sdk", "kotlin": "com.sdkwork.cloudrouter:cloudrouter-backend-sdk", "python": "sdkwork-cloudrouter-backend-sdk", "rust": "cloudrouter-backend-sdk", "swift": "CloudRouterBackendSdk", "typescript": "@sdkwork/cloudrouter-backend-sdk"};
const namespaces = {"csharp": "Sdkwork.CloudRouter.Backend", "java": "com.sdkwork.cloudrouter.backend", "kotlin": "com.sdkwork.cloudrouter.backend"};
...
function strictTypeScriptArgs() {
  return [
    ...
    '-o', 'sdks/cloudrouter-backend-sdk/cloudrouter-backend-sdk-typescript/generated/server-openapi',
    '-n', sdkFamily,
    '-t', sdkType,
    '-l', 'typescript',
    '--base-url', baseUrl,
...
function generatedOutputPath(language) {
  if (language === 'typescript') {
    return 'sdks/cloudrouter-backend-sdk/cloudrouter-backend-sdk-typescript/generated/server-openapi';
  }
