...
export class PaymentsProvidersApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/payments/providers`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
    /** Backend payment providers update */
    async update(providerId, body, requestOptions) {
        return this.client.request(backendApiPath(`/payments/providers/${serializePathParameter(providerId, { name: 'providerId', style: 'simple', explode: false })}`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'PATCH', body, contentType: 'application/json', sdkworkUnwrapKind: 'data' });
    }
}
