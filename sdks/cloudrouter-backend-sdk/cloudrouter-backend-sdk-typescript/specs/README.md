...
This directory is the local SDKWork component contract for `@sdkwork/cloudrouter-backend-sdk`.

- Component root: `sdkwork-cloudrouter/sdks/cloudrouter-backend-sdk/cloudrouter-backend-sdk-typescript`
