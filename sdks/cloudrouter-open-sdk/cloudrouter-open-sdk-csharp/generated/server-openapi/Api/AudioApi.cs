...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class AudioApi
    {
        ...
        public AudioApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// Create speech
        /// </summary>
        public async Task<string?> CreateSpeechAsync(Sdkwork.CloudRouter.Open.Models.OpenAiSpeechCreateRequest body)
        {
            return await _client.PostAsync<string>(ApiPaths.AiPath("/audio/speech"), body, null, null, "application/json");
        }

        /// <summary>
        /// Create transcription
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiAudioTranscription?> CreateTranscriptionAsync(Sdkwork.CloudRouter.Open.Models.OpenAiAudioTranscriptionRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiAudioTranscription>(ApiPaths.AiPath("/audio/transcriptions"), body, null, null, "application/json");
        }

        /// <summary>
        /// Create translation
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiAudioTranslation?> CreateTranslationAsync(Sdkwork.CloudRouter.Open.Models.OpenAiAudioTranslationRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiAudioTranslation>(ApiPaths.AiPath("/audio/translations"), body, null, null, "application/json");
        }

        /// <summary>
        /// List voice consents
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVoiceConsentList?> ListVoiceConsentsAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVoiceConsentList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/audio/voice_consents"), queryString));
        }

        /// <summary>
        /// Create voice consent
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVoiceConsent?> CreateVoiceConsentAsync(Sdkwork.CloudRouter.Open.Models.OpenAiVoiceConsentCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVoiceConsent>(ApiPaths.AiPath("/audio/voice_consents"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete voice consent
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteVoiceConsentsAsync(string consentId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/audio/voice_consents/{SerializePathParameter(consentId, new PathParameterSpec("consent_id", "simple", false))}"));
        }

        /// <summary>
        /// List voices
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVoiceList?> ListVoicesAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("limit", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVoiceList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/audio/voices"), queryString));
        }

        /// <summary>
        /// Create voice
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVoice?> CreateVoiceAsync(Sdkwork.CloudRouter.Open.Models.OpenAiVoiceCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVoice>(ApiPaths.AiPath("/audio/voices"), body, null, null, "application/json");
        }
