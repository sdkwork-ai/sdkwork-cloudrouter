...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class ChatApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletionList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null, string? model = null, string? metadata = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletionList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/chat/completions"), queryString));
        }

        /// <summary>
        /// Create chat completion
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletion?> CreateAsync(Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletionRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletion>(ApiPaths.AiPath("/chat/completions"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete stored chat completion
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteAsync(string completionId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/chat/completions/{SerializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve stored chat completion
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletion?> RetrieveAsync(string completionId)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletion>(ApiPaths.AiPath($"/chat/completions/{SerializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false))}"));
        }

        /// <summary>
        /// Modify stored chat completion
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletion?> UpdateAsync(string completionId, Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletionUpdateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletion>(ApiPaths.AiPath($"/chat/completions/{SerializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false))}"), body, null, null, "application/json");
        }

        /// <summary>
        /// List stored chat completion messages
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletionMessageList?> ListMessagesAsync(string completionId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("limit", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiChatCompletionMessageList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/chat/completions/{SerializePathParameter(completionId, new PathParameterSpec("completion_id", "simple", false))}/messages"), queryString));
        }
