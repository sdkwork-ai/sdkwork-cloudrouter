...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class BatchesAnthropicApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.AnthropicMessageBatchListResponse?> ListV1MessagesBatchesAsync(string? beforeId = null, string? afterId = null, int? limit = null)
        {
