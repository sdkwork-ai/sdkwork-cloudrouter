...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class AssistantsApi
    {
        ...
        public AssistantsApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// List assistants
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiAssistantList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiAssistantList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/assistants"), queryString));
        }

        /// <summary>
        /// Create assistant
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiAssistant?> CreateAsync(Sdkwork.CloudRouter.Open.Models.OpenAiAssistantCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiAssistant>(ApiPaths.AiPath("/assistants"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete assistant
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteAsync(string assistantId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/assistants/{SerializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve assistant
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiAssistant?> RetrieveAsync(string assistantId)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiAssistant>(ApiPaths.AiPath($"/assistants/{SerializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false))}"));
        }

        /// <summary>
        /// Modify assistant
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiAssistant?> UpdateAsync(string assistantId, Sdkwork.CloudRouter.Open.Models.OpenAiAssistantUpdateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiAssistant>(ApiPaths.AiPath($"/assistants/{SerializePathParameter(assistantId, new PathParameterSpec("assistant_id", "simple", false))}"), body, null, null, "application/json");
        }
