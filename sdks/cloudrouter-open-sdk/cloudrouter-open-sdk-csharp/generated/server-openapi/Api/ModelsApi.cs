...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class ModelsApi
    {
        ...
        public ModelsApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// List models
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiModelList?> ListAsync()
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiModelList>(ApiPaths.AiPath("/models"));
        }

        /// <summary>
        /// Retrieve model
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiModel?> RetrieveAsync(string model)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiModel>(ApiPaths.AiPath($"/models/{SerializePathParameter(model, new PathParameterSpec("model", "simple", false))}"));
        }
