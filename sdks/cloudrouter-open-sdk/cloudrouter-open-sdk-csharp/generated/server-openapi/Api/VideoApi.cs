...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class VideoApi
    {
        ...
        /// List videos
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideoList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideoList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/videos"), queryString));
        }

        /// <summary>
        /// Create video
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideo?> CreateAsync(Sdkwork.CloudRouter.Open.Models.OpenAiVideoCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideo>(ApiPaths.AiPath("/videos"), body, null, null, "application/json");
        }

        /// <summary>
        /// Create video character
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideoCharacter?> CreateCharacterAsync(Sdkwork.CloudRouter.Open.Models.OpenAiVideoCharacterCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideoCharacter>(ApiPaths.AiPath("/videos/characters"), body, null, null, "application/json");
        }

        /// <summary>
        /// Retrieve video character
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideoCharacter?> ListCharactersAsync(string characterId)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideoCharacter>(ApiPaths.AiPath($"/videos/characters/{SerializePathParameter(characterId, new PathParameterSpec("character_id", "simple", false))}"));
        }

        /// <summary>
        /// Edit video
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideo?> CreateEditAsync(Sdkwork.CloudRouter.Open.Models.OpenAiVideoEditRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideo>(ApiPaths.AiPath("/videos/edits"), body, null, null, "application/json");
        }

        /// <summary>
        /// Extend video
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideo?> CreateExtensionAsync(Sdkwork.CloudRouter.Open.Models.OpenAiVideoExtendRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideo>(ApiPaths.AiPath("/videos/extensions"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete video
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteAsync(string videoId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/videos/{SerializePathParameter(videoId, new PathParameterSpec("video_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve video
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideo?> RetrieveAsync(string videoId)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideo>(ApiPaths.AiPath($"/videos/{SerializePathParameter(videoId, new PathParameterSpec("video_id", "simple", false))}"));
        }
        ...
        /// Remix video
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiVideo?> CreateRemixAsync(string videoId, Sdkwork.CloudRouter.Open.Models.OpenAiVideoRemixRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiVideo>(ApiPaths.AiPath($"/videos/{SerializePathParameter(videoId, new PathParameterSpec("video_id", "simple", false))}/remix"), body, null, null, "application/json");
        }
