...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class FilesApi
    {
        ...
        public FilesApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// List files
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiFileList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiFileList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/files"), queryString));
        }

        /// <summary>
        /// Upload file
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiFile?> CreateAsync(Sdkwork.CloudRouter.Open.Models.OpenAiFileUploadRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiFile>(ApiPaths.AiPath("/files"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Delete file
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteAsync(string fileId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve file
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiFile?> RetrieveAsync(string fileId)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiFile>(ApiPaths.AiPath($"/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve file content
        /// </summary>
        public async Task<string?> ContentAsync(string fileId)
        {
            return await _client.GetAsync<string>(ApiPaths.AiPath($"/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}/content"));
        }
