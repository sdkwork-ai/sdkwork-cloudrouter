...
{
    public class AudioElevenlabsApi
    {
        private readonly SdkHttpClient _client;

        public AudioElevenlabsApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.ElevenLabsSoundGenerationResponse?> CreateV1SoundGenerationAsync(Sdkwork.CloudRouter.Open.Models.ElevenLabsSoundGenerationRequest body, string? outputFormat = null)
        {
        ...
        /// Synthesize speech
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.ElevenLabsTextToSpeechResponse?> CreateV1TextToSpeechAsync(string voiceId, Sdkwork.CloudRouter.Open.Models.ElevenLabsTextToSpeechRequest body, string? outputFormat = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("output_format", outputFormat, "form", true, false, null),
