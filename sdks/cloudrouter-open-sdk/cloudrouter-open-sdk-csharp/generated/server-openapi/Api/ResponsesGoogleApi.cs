...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class ResponsesGoogleApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.GoogleCachedContentListResponse?> ListV1betaCachedContentsAsync(int? pageSize = null, string? pageToken = null)
        {
