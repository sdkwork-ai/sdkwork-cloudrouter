...
namespace Sdkwork.CloudRouter.Open.Api
{
    public class ContainerApi
    {
        ...
        public ContainerApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// List containers
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiContainerList?> ListAsync(int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiContainerList>(ApiPaths.AppendQueryString(ApiPaths.AiPath("/containers"), queryString));
        }

        /// <summary>
        /// Create container
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiContainer?> CreateAsync(Sdkwork.CloudRouter.Open.Models.OpenAiContainerCreateRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiContainer>(ApiPaths.AiPath("/containers"), body, null, null, "application/json");
        }

        /// <summary>
        /// Delete container
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteAsync(string containerId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve container
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiContainer?> RetrieveAsync(string containerId)
        {
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiContainer>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}"));
        }

        /// <summary>
        /// List container files
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiContainerFileList?> ListFilesAsync(string containerId, int? limit = null, string? order = null, string? after = null, string? before = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("limit", limit, "form", true, false, null),
            ...
            return await _client.GetAsync<Sdkwork.CloudRouter.Open.Models.OpenAiContainerFileList>(ApiPaths.AppendQueryString(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files"), queryString));
        }

        /// <summary>
        /// Create container file
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.OpenAiContainerFile?> CreateFileAsync(string containerId, Sdkwork.CloudRouter.Open.Models.OpenAiContainerFileCreateMultipartRequest body)
        {
            return await _client.PostAsync<Sdkwork.CloudRouter.Open.Models.OpenAiContainerFile>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files"), body, null, null, "multipart/form-data");
        }

        /// <summary>
        /// Delete container file
        /// </summary>
        public async Task<Sdkwork.CloudRouter.Open.Models.DeleteResult?> DeleteFilesAsync(string containerId, string fileId)
        {
            return await _client.DeleteAsync<Sdkwork.CloudRouter.Open.Models.DeleteResult>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}"));
        }

        /// <summary>
        /// Retrieve container file content
        /// </summary>
        public async Task<string?> ListFilesContentAsync(string containerId, string fileId)
        {
            return await _client.GetAsync<string>(ApiPaths.AiPath($"/containers/{SerializePathParameter(containerId, new PathParameterSpec("container_id", "simple", false))}/files/{SerializePathParameter(fileId, new PathParameterSpec("file_id", "simple", false))}/content"));
        }
