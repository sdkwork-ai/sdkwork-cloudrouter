...
use crate::models::{GoogleCachedContent, GoogleCachedContentCreateRequest, GoogleCachedContentListResponse, GoogleEmptyResponse};
...
impl ResponsesGoogleApi {
    ...
    pub async fn list_v1beta_cached_contents(&self, page_size: Option<i64>, page_token: Option<&str>) -> Result<GoogleCachedContentListResponse, SdkworkError> {
