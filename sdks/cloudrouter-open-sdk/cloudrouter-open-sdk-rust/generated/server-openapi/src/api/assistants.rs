...
use crate::models::{
    DeleteResult, OpenAiAssistant, OpenAiAssistantCreateRequest, OpenAiAssistantList,
...
impl AssistantsApi {
    ...
    pub async fn list(
        ...
        after: Option<&str>,
        before: Option<&str>,
    ) -> Result<OpenAiAssistantList, SdkworkError> {
    ...
    pub async fn create(
        &self,
        body: &OpenAiAssistantCreateRequest,
    ) -> Result<OpenAiAssistant, SdkworkError> {
    ...
    pub async fn delete(&self, assistant_id: &str) -> Result<DeleteResult, SdkworkError> {
        let path = ai_path(&format!(
            ...
            serialize_path_parameter(
                assistant_id,
                PathParameterSpec::new("assistant_id", "simple", false)
            )
        ));
    ...
    pub async fn update(
        &self,
        assistant_id: &str,
        body: &OpenAiAssistantUpdateRequest,
    ) -> Result<OpenAiAssistant, SdkworkError> {
        let path = ai_path(&format!(
            "/assistants/{}",
            serialize_path_parameter(
