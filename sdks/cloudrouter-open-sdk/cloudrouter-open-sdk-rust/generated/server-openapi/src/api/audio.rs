...
impl AudioApi {
    ...
    /// Create speech
    pub async fn create_speech(&self, body: &OpenAiSpeechCreateRequest) -> Result<Vec<u8>, SdkworkError> {
    ...
    pub async fn create_speech_stream(&self, body: &OpenAiSpeechCreateRequest) -> Result<BinaryResponseStream, SdkworkError> {
        let path = ai_path(&"/audio/speech".to_string());
