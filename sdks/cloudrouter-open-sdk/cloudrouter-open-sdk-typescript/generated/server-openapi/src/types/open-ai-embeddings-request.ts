...
/** OpenAI-compatible open ai embeddings request schema exposed by Cloud Router. */
export interface OpenAiEmbeddingsRequest {
  ...
  /** Embedding model id or Cloud Router catalog key routed to a provider account. */
  model: string;
