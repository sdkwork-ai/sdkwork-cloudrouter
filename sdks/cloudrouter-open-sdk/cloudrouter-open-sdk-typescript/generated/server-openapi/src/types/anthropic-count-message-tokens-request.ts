...
/** Anthropic Claude anthropic count message tokens request schema exposed by Cloud Router vendor routing. */
export interface AnthropicCountMessageTokensRequest {
