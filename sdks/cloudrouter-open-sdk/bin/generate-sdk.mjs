...
const sdkFamily = 'cloudrouter-open-sdk';
const sdkType = 'ai';
...
const apiPrefix = '/v1';
const description = 'SDKWork Cloud Router OpenAI-compatible gateway SDK';
const OFFICIAL_LANGUAGES = ['typescript', 'flutter', 'rust', 'java', 'csharp', 'swift', 'kotlin', 'go', 'python'];
const packageNames = {"csharp": "Sdkwork.CloudRouter.Open.Sdk", "flutter": "cloudrouter_open_sdk", "go": "github.com/sdkwork/cloudrouter-open-sdk", "java": "com.sdkwork.cloudrouter:cloudrouter-open-sdk", "kotlin": "com.sdkwork.cloudrouter:cloudrouter-open-sdk", "python": "sdkwork-cloudrouter-open-sdk", "rust": "cloudrouter-open-sdk", "swift": "CloudRouterOpenSdk", "typescript": "@sdkwork/cloudrouter-open-sdk"};
const namespaces = {"csharp": "Sdkwork.CloudRouter.Open", "java": "com.sdkwork.cloudrouter.open", "kotlin": "com.sdkwork.cloudrouter.open"};
...
function strictTypeScriptArgs() {
  return [
    ...
    'generate',
    '-i', sdkgenInputPath,
    '-o', 'sdks/cloudrouter-open-sdk/cloudrouter-open-sdk-typescript/generated/server-openapi',
    '-n', sdkFamily,
    '-t', sdkType,
    '-l', 'typescript',
    '--base-url', baseUrl,
...
function generatedOutputPath(language) {
  if (language === 'typescript') {
    return 'sdks/cloudrouter-open-sdk/cloudrouter-open-sdk-typescript/generated/server-openapi';
  }
