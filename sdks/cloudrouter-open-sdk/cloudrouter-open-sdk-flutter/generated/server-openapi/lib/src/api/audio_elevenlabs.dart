...
class AudioElevenlabsApi {
  ...
  AudioElevenlabsApi(this._client);

  /// Generate sound effect
  Future<ElevenLabsSoundGenerationResponse?> createV1SoundGeneration(ElevenLabsSoundGenerationRequest body, [String? outputFormat]) async {
  ...
  /// Synthesize speech
  Future<ElevenLabsTextToSpeechResponse?> createV1TextToSpeech(String voiceId, ElevenLabsTextToSpeechRequest body, [String? outputFormat]) async {
    final query = buildQueryString([
      QueryParameterSpec('output_format', outputFormat, 'form', true, false, null)
    ]);
    final payload = body.toJson();
