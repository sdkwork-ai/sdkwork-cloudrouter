# cloudrouter-open-sdk (Flutter)

SDKWork Cloud Router OpenAI-compatible gateway SDK flutter generated transport SDK
...
```yaml
dependencies:
  cloudrouter_open_sdk: ^0.1.0
```

## Quick Start

```dart
import 'package:cloudrouter_open_sdk/cloudrouter_open_sdk.dart';
