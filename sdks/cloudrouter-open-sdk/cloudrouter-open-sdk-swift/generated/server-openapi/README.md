# cloudrouter-open-sdk (Swift)

SDKWork Cloud Router OpenAI-compatible gateway SDK swift generated transport SDK
...
```swift
dependencies: [
    .package(url: "https://github.com/sdkwork/CloudRouterOpenSdk", from: "0.1.0")
]
```
