...
public class AudioElevenlabsApi {
    ...
    public func createV1SoundGeneration(body: ElevenLabsSoundGenerationRequest, outputFormat: String? = nil) async throws -> ElevenLabsSoundGenerationResponse? {
    ...
    /// Synthesize speech
    public func createV1TextToSpeech(voiceId: String, body: ElevenLabsTextToSpeechRequest, outputFormat: String? = nil) async throws -> ElevenLabsTextToSpeechResponse? {
        let query = buildQueryString([
            QueryParameterSpec(name: "output_format", value: outputFormat, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
