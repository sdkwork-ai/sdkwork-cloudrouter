...
class AudioElevenlabsApi(private val client: HttpClient) {

    /** Generate sound effect */
    suspend fun createV1SoundGeneration(body: ElevenLabsSoundGenerationRequest, outputFormat: String? = null): ElevenLabsSoundGenerationResponse? {
    ...
    /** Synthesize speech */
    suspend fun createV1TextToSpeech(voiceId: String, body: ElevenLabsTextToSpeechRequest, outputFormat: String? = null): ElevenLabsTextToSpeechResponse? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("output_format", outputFormat, "form", true, false, null)
        ))
