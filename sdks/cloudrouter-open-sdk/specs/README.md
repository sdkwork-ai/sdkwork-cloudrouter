# SDKWork Cloud Router OpenAI-compatible gateway SDK Component Specs

This directory is the local standards index for `cloudrouter-open-sdk`.
...
| Field | Value |
| --- | --- |
| Name | `cloudrouter-open-sdk` |
| Type | `sdk-family` |
| Root | `sdkwork-cloudrouter/sdks/cloudrouter-open-sdk` |
| Domain | `platform` |
| Capability | `router` |
