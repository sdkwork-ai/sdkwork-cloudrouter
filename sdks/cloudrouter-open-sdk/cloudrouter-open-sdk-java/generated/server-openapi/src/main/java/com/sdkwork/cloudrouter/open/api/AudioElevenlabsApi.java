...
public class AudioElevenlabsApi {
    ...
    public AudioElevenlabsApi(HttpClient client) {
        this.client = client;
    }

    /** Generate sound effect */
    public ElevenLabsSoundGenerationResponse createV1SoundGeneration(ElevenLabsSoundGenerationRequest body, String outputFormat) throws Exception {
    ...
    /** Synthesize speech */
    public ElevenLabsTextToSpeechResponse createV1TextToSpeech(String voiceId, ElevenLabsTextToSpeechRequest body, String outputFormat) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("output_format", outputFormat, "form", true, false, null)
        ));
