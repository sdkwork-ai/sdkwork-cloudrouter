...
type ImagesNanoBananaApi struct {
    client *sdkhttp.Client
}

func NewImagesNanoBananaApi(client *sdkhttp.Client) *ImagesNanoBananaApi {
    return &ImagesNanoBananaApi{client: client}
}
...
func (a *ImagesNanoBananaApi) CreateGeneration(body sdktypes.NanoBananaImageGenerationRequest) (sdktypes.NanoBananaImageGenerationTask, error) {
    ...
    return decodeResult[sdktypes.NanoBananaImageGenerationTask](raw)
}
