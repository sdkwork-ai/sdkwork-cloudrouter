...
type AudioElevenlabsApi struct {
    client *sdkhttp.Client
}

func NewAudioElevenlabsApi(client *sdkhttp.Client) *AudioElevenlabsApi {
    return &AudioElevenlabsApi{client: client}
}

// Generate sound effect
func (a *AudioElevenlabsApi) CreateV1SoundGeneration(body sdktypes.ElevenLabsSoundGenerationRequest, outputFormat *string) (sdktypes.ElevenLabsSoundGenerationResponse, error) {
    ...
    return decodeResult[sdktypes.ElevenLabsSoundGenerationResponse](raw)
}

// Synthesize speech
func (a *AudioElevenlabsApi) CreateV1TextToSpeech(voiceId string, body sdktypes.ElevenLabsTextToSpeechRequest, outputFormat *string) (sdktypes.ElevenLabsTextToSpeechResponse, error) {
    query := BuildQueryString([]QueryParameterSpec{
        {Name: "output_format", Value: func() interface{} { if outputFormat == nil { return nil }; return *outputFormat }(), Style: "form", Explode: true, AllowReserved: false},
    })
    ...
    return decodeResult[sdktypes.ElevenLabsTextToSpeechResponse](raw)
}
