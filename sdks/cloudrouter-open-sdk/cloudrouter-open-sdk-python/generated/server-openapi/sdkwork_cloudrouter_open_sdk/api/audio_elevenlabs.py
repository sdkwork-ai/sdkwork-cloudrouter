...
from ..models import ElevenLabsSoundGenerationRequest, ElevenLabsSoundGenerationResponse, ElevenLabsTextToSpeechRequest, ElevenLabsTextToSpeechResponse
...
class AudioElevenlabsApi:
    """audio_elevenlabs API client."""

    def __init__(self, client: HttpClient):
        self._client = client

    def create_v1_sound_generation(self, body: ElevenLabsSoundGenerationRequest, output_format: Optional[str] = None) -> ElevenLabsSoundGenerationResponse:
